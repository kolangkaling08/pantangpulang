...
if (isset($_GET['q'])) {
    ...
    if ($currentIndex >= 0) {
        ...
        // Angka konsisten (1-100)
        $Number = (crc32($BRAND) % 100) + 1;

        // Ambil 10 keyword berikutnya (loop jika mentok akhir file)
        $nextKeywords = [];
        for ($i = 1; $i <= 10; $i++) {
...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://solution-isasoftgestiondocumental.pages.dev/<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title>ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan ISAsoft Gestión Documental menyediakan layanan digitalisasi dokumen, sistem manajemen arsip elektronik, serta konsultasi untuk efisiensi operasional dan kepatuhan regulasi.">

    <meta name="viewport" content="width=device-width,initial-scale=1">
    <link rel="icon" type="image/x-icon" href="https://justkid.pages.dev/logo.png">
    <link rel="apple-touch-icon-precomposed" type="image/x-icon"
        href="https://justkid.pages.dev/logo.png"
        sizes="72x72">
    <link rel="apple-touch-icon-precomposed" type="image/x-icon"
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional",
  "image": "https://justkid.pages.dev/logo.png",
  "description": "<?php echo $BRANDS ?> dan ISAsoft Gestión Documental menyediakan layanan digitalisasi dokumen, sistem manajemen arsip elektronik, serta konsultasi untuk efisiensi operasional dan kepatuhan regulasi.",
  "brand": {
    "@type": "Brand",
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?php echo $BRANDS ?>",
      "item": "https://isasoftgestiondocumental.com/solution/<?php echo $BRANDS1 ?>"
    },
    {
      "@type": "ListItem",
      "position": 2,
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional">
    <meta property="og:description"
        content="<?php echo $BRANDS ?> dan ISAsoft Gestión Documental menyediakan layanan digitalisasi dokumen, sistem manajemen arsip elektronik, serta konsultasi untuk efisiensi operasional dan kepatuhan regulasi.">
    <meta property="og:image" content="https://justkid.pages.dev/71.png">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:type" content="website">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan ISAsoft Gestión Documental menyediakan layanan digitalisasi dokumen, sistem manajemen arsip elektronik, serta konsultasi untuk efisiensi operasional dan kepatuhan regulasi.">
    <meta name="twitter:image" content="https://justkid.pages.dev/71.png">
    <meta property="og:title" content="ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:image" content="https://justkid.pages.dev/71.png" />
                            ...
                            <div class="header-mini" bis_skin_checked="1">
                                ...
                                <div class="header-mini__logo" bis_skin_checked="1">
                                    <a href="<?php echo $urlPath ?>">
                                        <img alt="Logo Baru"
                                            src="https://justkid.pages.dev/logo.png"
                                    ...
                                    <nav class="header-site-titles__container">
                                        ...
                                        <div class="header-site-floating-logo__container" bis_skin_checked="1">
                                            <div class="" bis_skin_checked="1">
                                                <img src="https://justkid.pages.dev/logo.png"
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone">ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong>ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional</strong>
...
<!-- Section 2 -->
                    ...
                    <div class="content-main" id="content" bis_skin_checked="1">
                        ...
                        <div class="grid-container" bis_skin_checked="1">
                            <script nonce="TFNQUvYHwdi8uHoMheRs/Q==">
                                //<![CDATA[
                                window.GtmMeasurements.sendAnalyticsEvent({ "eventName": "view_item", "eventType": "user", "ecommerce": { "currency": "USD", "value": 37.0, "items": [{ "affiliation": "themeforest", "item_id": 8988002, "item_name": ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional Hari Ini", "item_brand": "tokopress", "item_category": "wordpress", "item_category2": "ecommerce", "item_category3": "woocommerce", "price": 37.0, "quantity": 1, "item_add_on": "bundle_6month", "item_variant": "regular" }] } });
                            ...
                            <div bis_skin_checked="1">
                                <link href="https://justkid.pages.dev/logo.png">
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional - WooCommerce eCommerce"
                                                    width="300" height="300"
                                                    srcset="https://justkid.pages.dev/71.png"
                                                    sizes="(min-width: 1024px) 590px, (min-width: 1px) 100vw, 600px"
                                                    src="https://justkid.pages.dev/71.png"></a>
                                            <div class="js- item-preview-image__gallery"
                                                data-title="ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                            ...
                                            <div class="item-preview__actions" bis_skin_checked="1">
                                                <div id="fullscreen" class="item-preview__preview-buttons"
                                                    ...
                                                    <a href="https://link.space/@PASTIWIN805"
                                                    ...
                                                    <a data-view="screenshotGallery"
                                                        href="https://linktr.ee/PASTIWIN805"
                                ...
                                <div class="sidebar-l sidebar-right" bis_skin_checked="1">
                                        ...
                                        <div class="purchase-panel" bis_skin_checked="1">
                                            <div id="purchase-form" class="purchase-form" bis_skin_checked="1">
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    data-analytics-click-payload="{&quot;eventName&quot;:&quot;add_to_cart&quot;,&quot;eventType&quot;:&quot;user&quot;,&quot;quantityUpdate&quot;:false,&quot;ecommerce&quot;:{&quot;currency&quot;:&quot;USD&quot;,&quot;value&quot;:37.0,&quot;items&quot;:[{&quot;affiliation&quot;:&quot;themeforest&quot;,&quot;item_id&quot;:8988002,&quot;item_name&quot;:&quot;ISAsoft Gestión Documental | <?php echo $BRANDS ?> Solusi Digitalisasi & Manajemen Dokumen Profesional&quot;,&quot;item_brand&quot;:&quot;tokopress&quot;,&quot;item_category&quot;:&quot;wordpress&quot;,&quot;item_category2&quot;:&quot;ecommerce&quot;,&quot;item_category3&quot;:&quot;woocommerce&quot;,&quot;price&quot;:&quot;37&quot;,&quot;quantity&quot;:1}]}}"
                                                    action="<?php echo $urlPath ?>"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama ISAsoft Gestión Documental menawarkan layanan digitalisasi dan manajemen dokumen elektronik untuk membantu organisasi mengelola informasi secara efisien dan aman. Dengan pendekatan berbasis teknologi, mereka menyediakan solusi untuk mengonversi dokumen fisik menjadi format digital, mengorganisir arsip elektronik, serta mengimplementasikan sistem manajemen dokumen yang mematuhi standar dan regulasi yang berlaku. Layanan ini bertujuan untuk meningkatkan produktivitas, mengurangi penggunaan kertas, dan mempermudah akses informasi bagi pengguna yang berwenang. ISAsoft Gestión Documental juga memberikan konsultasi untuk merancang dan mengoptimalkan alur kerja pengelolaan dokumen, sehingga organisasi dapat mencapai efisiensi operasional yang maksimal dan memastikan kepatuhan terhadap regulasi yang relevan.</p>
                                    ...
                                    <div class="t-body -size-s h-text-align-center h-mt2" bis_skin_checked="1">
                                        © All Rights Reserved <?php echo $BRANDS ?>
                                        <br>
                                        Contact the <a href="<?php echo $urlPath ?>">slot gacor</a> Help Team
                                    </div>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://isasoftgestiondocumental.com/solution/<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://isasoftgestiondocumental.com/solution/<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
