...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://product-qcircle.pages.dev/<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title>Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan Q Circle menyajikan platform edukasi dan kewirausahaan terpadu, mendukung ide kreatif dan pengembangan usaha dengan teknologi modern.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan",
  "image": "https://jpterus66.calcufast.xyz/JPTERUS66/favicon.png",
  "description": "<?php echo $BRANDS ?> dan Q Circle menyajikan platform edukasi dan kewirausahaan terpadu, mendukung ide kreatif dan pengembangan usaha dengan teknologi modern.",
  "brand": {
    "@type": "Brand",
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?php echo $BRANDS ?>",
      "item": "https://qcircle.co.in/product/<?php echo $BRANDS1 ?>"
    },
    {
      "@type": "ListItem",
      "position": 2,
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan">
    ...
    <meta name="twitter:title" content="Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan Q Circle menyajikan platform edukasi dan kewirausahaan terpadu, mendukung ide kreatif dan pengembangan usaha dengan teknologi modern.">
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone">Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong>Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan</strong>
...
<!-- Section 2 -->
                    ...
                    <div class="content-main" id="content" bis_skin_checked="1">
                        ...
                        <div class="grid-container" bis_skin_checked="1">
                            <script nonce="TFNQUvYHwdi8uHoMheRs/Q==">
                                //<![CDATA[
                                window.GtmMeasurements.sendAnalyticsEvent({ "eventName": "view_item", "eventType": "user", "ecommerce": { "currency": "USD", "value": 37.0, "items": [{ "affiliation": "themeforest", "item_id": 8988002, "item_name": Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan Hari Ini", "item_brand": "tokopress", "item_category": "wordpress", "item_category2": "ecommerce", "item_category3": "woocommerce", "price": 37.0, "quantity": 1, "item_add_on": "bundle_6month", "item_variant": "regular" }] } });
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/jpterus66/"><img
                                                    alt="Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan - WooCommerce eCommerce"
                                            ...
                                            <div class="js- item-preview-image__gallery"
                                                data-title="Q Circle | <?php echo $BRANDS ?> Platform Inovatif untuk Pendidikan dan Kewirausahaan Berkelanjutan Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama Q Circle menghadirkan sebuah platform yang menaungi aktivitas pendidikan dan kewirausahaan secara terpadu. Di Q Circle, anggota dapat bertukar gagasan, mengembangkan inovasi, serta mendapatkan dukungan praktis untuk menumbuhkan bisnis. Platform ini menggabungkan aspek edukasi dan aplikatif agar ide-ide kreatif dapat dieksekusi secara nyata. Dengan pendekatan teknologi digital dan komunitas yang kuat, Q Circle membantu memperluas jaringan, meningkatkan kemampuan wirausaha, dan menciptakan peluang baru dalam ekosistem pendidikan dan bisnis.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://qcircle.co.in/product/<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://qcircle.co.in/product/<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
