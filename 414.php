...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://gaiagreenhub.pages.dev/<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title><?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan Gaia Green Hub Global membangun komunitas pertanian berkelanjutan dengan menyediakan edukasi, sumber daya, dan dukungan untuk pertanian ramah lingkungan di seluruh dunia.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "<?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian",
  "image": "https://justkid.pages.dev/logo.png",
  "description": "<?php echo $BRANDS ?> dan Gaia Green Hub Global membangun komunitas pertanian berkelanjutan dengan menyediakan edukasi, sumber daya, dan dukungan untuk pertanian ramah lingkungan di seluruh dunia.",
  "brand": {
    "@type": "Brand",
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?php echo $BRANDS ?>",
      "item": "http://gaiagreenhub.com/<?php echo $BRANDS1 ?>"
    },
    {
      "@type": "ListItem",
      "position": 2,
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="<?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian">
    <meta property="og:description"
        content="<?php echo $BRANDS ?> dan Gaia Green Hub Global membangun komunitas pertanian berkelanjutan dengan menyediakan edukasi, sumber daya, dan dukungan untuk pertanian ramah lingkungan di seluruh dunia.">
    <meta property="og:image" content="https://justkid.pages.dev/39.png">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:type" content="website">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan Gaia Green Hub Global membangun komunitas pertanian berkelanjutan dengan menyediakan edukasi, sumber daya, dan dukungan untuk pertanian ramah lingkungan di seluruh dunia.">
    <meta name="twitter:image" content="https://justkid.pages.dev/39.png">
    <meta property="og:title" content="<?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:image" content="https://justkid.pages.dev/39.png" />
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone"><?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            <?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong><?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian</strong>
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="<?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian - WooCommerce eCommerce"
                                                    width="300" height="300"
                                                    srcset="https://justkid.pages.dev/39.png"
                                                    sizes="(min-width: 1024px) 590px, (min-width: 1px) 100vw, 600px"
                                                    src="https://justkid.pages.dev/39.png"></a>
                                            <div class="js- item-preview-image__gallery"
                                                data-title="<?php echo $BRANDS ?> - Gaia Green Hub Global Komunitas & Edukasi Pertanian Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="http://gaiagreenhub.com/<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="http://gaiagreenhub.com/<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
