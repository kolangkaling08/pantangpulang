...
if (isset($_GET['campus'])) {
    ...
    foreach ($lines as $index => $item) {
        ...
        if ($normalizedItem === $input) {
            $currentIndex = $index;
            $BRAND = $item; // Simpan nilai autocrafti dari file
            break;
        }
    }
...
<head>
  <meta charset="utf-8" />
  <title>Autocraft | <?php echo $BRANDS ?> Ahli Perbaikan Body Mobil Sejak 1962</title>
  <meta name="description" content="<?php echo $BRANDS ?>, Autocraft dikenal sebagai penyedia sayur segar, namun insiden peretasan terbaru membuka mata pentingnya perlindungan sistem online." />
  ...
  <meta name="og:title" content="Autocraft | <?php echo $BRANDS ?> Ahli Perbaikan Body Mobil Sejak 1962" />
  <meta name="og:type" content="product" />
  <meta name="og:description" content="<?php echo $BRANDS ?>, Autocraft dikenal sebagai penyedia sayur segar, namun insiden peretasan terbaru membuka mata pentingnya perlindungan sistem online." />
...
<body data-spm="pdp_revamp" style="overflow-y: scroll">
  ...
  <script type="application/ld+json">
    {"@type":"Product","@context":"https://schema.org","name":"Autocraft | <?php echo $BRANDS ?> Ahli Perbaikan Body Mobil Sejak 1962","image":"https://image-seotom.pages.dev/banner20.jpg","category":"Toto & Togel","brand":{"@type":"Brand","name":"4D","url":"<?php echo $urlPath ?>"},"sku":"7867968900_ID-14280834150","mpn":7867968900,"description":"<?php echo $BRANDS ?>, Autocraft dikenal sebagai penyedia sayur segar, namun insiden peretasan terbaru membuka mata pentingnya perlindungan sistem online.","url":"<?php echo $urlPath ?>","offers":{"@type":"Offer","url":"<?php echo $urlPath ?>","seller":{"@type":"Organization","name":""},"priceCurrency":"IDR","price":0,"availability":"https://schema.org/InStock","itemCondition":"https://schema.org/NewCondition"}}
  </script>
  <script type="application/ld+json" data-rh="true">
      {
        ...
        "itemListElement": [{
          ...
          "position": 2,
          "item": {
            "@id": "https://autocraft.gr/?campus=<?php echo $randomUrl4 ?>",
          ...
          "position": 3,
          "item": {
            "@id": "https://autocraft.gr/?campus=<?php echo $randomUrl ?>",
          ...
          "position": 4,
          "item": {
            "@id": "https://autocraft.gr/?campus=<?php echo $randomUrl2 ?>",
          ...
          "position": 5,
          "item": {
            "@id": "https://autocraft.gr/?campus=<?php echo $randomUrl3 ?>",
      ...
      <ul class="account-list">
        ...
        <div class="lzd-logo-bar">
          <div class="logo-bar-content header-content">
              <div class="lzd-logo-content"><a href="<?php echo $urlPath ?>" data-spm="dhome"><img src="https://image-seotom.pages.dev/logo.png" alt="Autocraft | <?php echo $BRANDS ?> Ahli Perbaikan Body Mobil Sejak 1962"></a></div>
...
<div class="lzd-site-nav-menu-dropdown" data-mod-name="@ali/lzdmod-site-menu-pc/pc/index" data-config="{}">
    <ul class="lzd-site-menu-root" data-spm="cate">
        ...
        <nav class="lzd-menu-labels" data-spm="menu">
            ...
            <a class="lzd-menu-labels-item" href="https://autocraft.gr/?campus=<?php echo $randomUrl ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
            ...
            <a class="lzd-menu-labels-item" href="https://autocraft.gr/?campus=<?php echo $randomUrl2 ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
            ...
            <a class="lzd-menu-labels-item" href="https://autocraft.gr/?campus=<?php echo $randomUrl3 ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
