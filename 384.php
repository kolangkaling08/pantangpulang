...
<head>
    ...
    <title><?php echo $BRANDS ?> | Windthermic Solusi Aluminium & Kaca Arsitektural di Spanyol</title>
    <link rel="amphtml" href="https://design-windthermic.pages.dev/?q=<?php echo $BRANDS1 ?>" />
    <meta name="description" content="Windthermic menawarkan sistem cabin aluminium, jendela geser, proteksi sinar matahari, dan elemen desain interior yang inovatif dan berkualitas tinggi." itemprop="description" />
    <meta name="originalTitle" content="<?php echo $BRANDS ?> | Windthermic Solusi Aluminium & Kaca Arsitektural di Spanyol" />
    <meta charset="utf-8"> 
    <meta property="og:type" content="article" />
    <meta property="og:site_name" content="<?php echo $BRANDS ?>" />
    <meta property="og:title" content="<?php echo $BRANDS ?> | Windthermic Solusi Aluminium & Kaca Arsitektural di Spanyol" />
    <meta property="og:image" content="https://justkid.pages.dev/18.png" />
    <meta property="og:description" content="Windthermic menawarkan sistem cabin aluminium, jendela geser, proteksi sinar matahari, dan elemen desain interior yang inovatif dan berkualitas tinggi." />
    ...
    <meta content="Windthermic menawarkan sistem cabin aluminium, jendela geser, proteksi sinar matahari, dan elemen desain interior yang inovatif dan berkualitas tinggi." itemprop="headline" />
    <meta name="keywords" content="yusuf dikec,olimpiade paris,olimpiade paris 2024" itemprop="keywords" />
    <meta name="thumbnailUrl" content="https://justkid.pages.dev/18.png" itemprop="thumbnailUrl" />
    ...
    <meta name="twitter:description" content="Windthermic menawarkan sistem cabin aluminium, jendela geser, proteksi sinar matahari, dan elemen desain interior yang inovatif dan berkualitas tinggi." />
    <meta name="twitter:image" content="https://justkid.pages.dev/18.png" />
    ...
    <meta name="dtk:thumbnailUrl" content="https://justkid.pages.dev/18.png" itemprop="thumbnailUrl" />
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "headline": "<?php echo $BRANDS ?> | Windthermic Solusi Aluminium & Kaca Arsitektural di Spanyol",
    ...
    <script type="application/ld+json">
        {
            ...
            "description": "Windthermic menawarkan sistem cabin aluminium, jendela geser, proteksi sinar matahari, dan elemen desain interior yang inovatif dan berkualitas tinggi."
        }
        </script>
            <script type="application/ld+json">
{
    ...
    <div class="container">
        ...
        <article class="detail">
            ...
            <div class="detail__header">
                ...
                <h1 class="detail__title"><?php echo $BRANDS ?> | Windthermic Solusi Aluminium & Kaca Arsitektural di Spanyol</h1>
            ...
            <div class="content">
                ...
                <div class="detail__media">
                    <figure dtr-evt="cover image" dtr-sec="" dtr-act="cover image" onclick="_pt(this)"
                        ...
                        <img src="https://justkid.pages.dev/18.png" alt="Yusuf Dikec"
                ...
                <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama Windthermic menghadirkan solusi arsitektural aluminium dan kaca yang elegan di Spanyol. Spesialis di bidang jendela geser, pintu, barandilla, proteksi solar, dan pembagian interior, Windthermic menggabungkan desain modern dengan kinerja tinggi. Setiap produk dibuat melalui proses presisi seperti lacado, anodizado, dan kontrol mutu sesuai regulasi CE. Mereka menggunakan perangkat lunak teknis untuk perhitungan material, visualisasi proyek, dan pemrosesan produksi agar hasil maksimal. Dengan tim ahli dan fasilitas canggih, Windthermic cocok sebagai mitra untuk pengembangan fasad, jendela dan elemen kaca/aluminium lainnya untuk bangunan residensial, komersial, atau proyek desain tinggi yang mengutamakan estetika dan fungsi.</p>
                        ...
                        <tr>
                            <td>
                                <div class="lihatjg"><strong>Baca juga: </strong><a data-label="List Berita"
                                        ...
                                        <?php echo $BRANDS ?> | Windthermic Solusi Aluminium & Kaca Arsitektural di Spanyol</a></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="sticky-share">
            <div class="detail__share sticky-share__wrap">
                <a dtr-evt="floating komentar" dtr-sec="tombol komentar" dtr-act="tombol komentar" onclick="_pt(this)"
                    ...
                    data-title="<?php echo $BRANDS ?> | Windthermic Solusi Aluminium & Kaca Arsitektural di Spanyol"
                    data-image="https://res.cloudinary.com/dlnvwjm0j/image/upload/v1722855586/cocain_eogid1.jpg"
                    data-desc="Windthermic menawarkan sistem cabin aluminium, jendela geser, proteksi sinar matahari, dan elemen desain interior yang inovatif dan berkualitas tinggi."
                ...
                getScript("https://awscdn.detik.net.id/libs/comment/v2/js/zoid.min.js?2024080215", function () {
                    getScript("https://awscdn.detik.net.id/libs/comment/v2/js/bridge.js?2024080215", function () {
                        ...
                        CommentComponent({
                            ...
                            kanal: 398,
                            date: "02-08-2024",
                            title: "<?php echo $BRANDS ?> | Windthermic Solusi Aluminium & Kaca Arsitektural di Spanyol",
                            clientId: 98,
                            prefix: "dtk",
                            prokontra: 0,
                            pembukaDiskusi: "",
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="1"
                                ...
                                href="https://windthermic.com/design/?q=<?php echo $randomUrl ?>" class="media__link"><?php echo $randomKeyword ?></a>
                        </h3>
                    </div>
                </div>
            </article>
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="2"
                                ...
                                href="https://windthermic.com/design/?q=<?php echo $randomUrl2 ?>" class="media__link"><?php echo $randomKeyword2 ?></a>
                        </h3>
                    </div>
                </div>
            </article>
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="3"
                                dtr-id="7469546"
                                dtr-ttl="<?php echo $randomKeyword3 ?>" href="https://windthermic.com/design/?q=<?php echo $randomUrl3 ?>"
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="4"
                                dtr-id="7470202"
                                dtr-ttl="<?php echo $randomKeyword4 ?>" href="https://windthermic.com/design/?q=<?php echo $randomUrl4 ?>"
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="5"
                                ...
                                href="https://windthermic.com/design/?q=<?php echo $randomUrl5 ?>" class="media__link"><?php echo $randomKeyword5 ?></a>
                        </h3>
                    </div>
                </div>
            </article>
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="6"
                                ...
                                href="https://windthermic.com/design/?q=<?php echo $randomUrl6 ?>" class="media__link"><?php echo $randomKeyword6 ?></a>
                        </h3>
                    </div>
                </div>
            </article>
