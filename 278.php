...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://campus-procomcomputer.pages.dev/?q=<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title>ProCom Computer | <?php echo $BRANDS ?> Portal Kursus Desain Digital, Software, Kreatif Profesional</title>
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "ProCom Computer | <?php echo $BRANDS ?> Portal Kursus Desain Digital, Software, Kreatif Profesional",
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="ProCom Computer | <?php echo $BRANDS ?> Portal Kursus Desain Digital, Software, Kreatif Profesional">
    ...
    <meta name="twitter:title" content="ProCom Computer | <?php echo $BRANDS ?> Portal Kursus Desain Digital, Software, Kreatif Profesional">
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone">ProCom Computer | <?php echo $BRANDS ?> Portal Kursus Desain Digital, Software, Kreatif Profesional</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            ProCom Computer | <?php echo $BRANDS ?> Portal Kursus Desain Digital, Software, Kreatif Profesional
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong>ProCom Computer | <?php echo $BRANDS ?> Portal Kursus Desain Digital, Software, Kreatif Profesional</strong>
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="ProCom Computer | <?php echo $BRANDS ?> Portal Kursus Desain Digital, Software, Kreatif Profesional - WooCommerce eCommerce"
                                            ...
                                            <div class="js- item-preview-image__gallery"
                                                data-title="ProCom Computer | <?php echo $BRANDS ?> Portal Kursus Desain Digital, Software, Kreatif Profesional Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama ProCom Computer Centre mempersembahkan portal pembelajaran kreatif yang menyediakan kursus-kursus terfokus di bidang desain digital dan software profesional. Di ProCom tersedia pelatihan seperti AutoCAD, 3ds Max, Adobe suite, desain interior, ilustrasi, web design, editing video dan publishing desktop. Kursus disusun dengan materi praktis dan jam pelajaran yang terstruktur agar peserta bisa belajar sesuai ritme mereka sendiri, baik lewat tatap muka di kampus maupun online. Portal ini juga dilengkapi galeri hasil karya siswa untuk melihat contoh nyata dan inspiratif.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://procomcomputer.com.my/campus/?q=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://procomcomputer.com.my/campus/?q=<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
