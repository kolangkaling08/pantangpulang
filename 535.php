...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://service-jgdgroup.pages.dev/<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title>JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan JGD Group menghadirkan layanan manufaktur pallet kayu, kotak kayu & bahan pengemasan industri dengan kualitas tinggi dan sertifikasi ISO.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya",
  "image": "https://jpterus66.calcufast.xyz/JPTERUS66/favicon.png",
  "description": "<?php echo $BRANDS ?> dan JGD Group menghadirkan layanan manufaktur pallet kayu, kotak kayu & bahan pengemasan industri dengan kualitas tinggi dan sertifikasi ISO.",
  "brand": {
    "@type": "Brand",
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?php echo $BRANDS ?>",
      "item": "https://jgdgroup.co.za/service/<?php echo $BRANDS1 ?>"
    },
    {
      "@type": "ListItem",
      "position": 2,
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya">
    <meta property="og:description"
        content="<?php echo $BRANDS ?> dan JGD Group menghadirkan layanan manufaktur pallet kayu, kotak kayu & bahan pengemasan industri dengan kualitas tinggi dan sertifikasi ISO.">
    <meta property="og:image" content="https://jpterus66.calcufast.xyz/JPTERUS66/banner-19.png">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:type" content="website">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan JGD Group menghadirkan layanan manufaktur pallet kayu, kotak kayu & bahan pengemasan industri dengan kualitas tinggi dan sertifikasi ISO.">
    <meta name="twitter:image" content="https://jpterus66.calcufast.xyz/JPTERUS66/banner-19.png">
    <meta property="og:title" content="JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:image" content="https://jpterus66.calcufast.xyz/JPTERUS66/banner-19.png" />
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone">JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong>JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya</strong>
...
<!-- Section 2 -->
                    ...
                    <div class="content-main" id="content" bis_skin_checked="1">
                        ...
                        <div class="grid-container" bis_skin_checked="1">
                            <script nonce="TFNQUvYHwdi8uHoMheRs/Q==">
                                //<![CDATA[
                                window.GtmMeasurements.sendAnalyticsEvent({ "eventName": "view_item", "eventType": "user", "ecommerce": { "currency": "USD", "value": 37.0, "items": [{ "affiliation": "themeforest", "item_id": 8988002, "item_name": JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya Hari Ini", "item_brand": "tokopress", "item_category": "wordpress", "item_category2": "ecommerce", "item_category3": "woocommerce", "price": 37.0, "quantity": 1, "item_add_on": "bundle_6month", "item_variant": "regular" }] } });
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/jpterus66/"><img
                                                    alt="JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya - WooCommerce eCommerce"
                                                    width="300" height="300"
                                                    srcset="https://jpterus66.calcufast.xyz/JPTERUS66/banner-19.png"
                                                    sizes="(min-width: 1024px) 590px, (min-width: 1px) 100vw, 600px"
                                                    src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-19.png"></a>
                                            <div class="js- item-preview-image__gallery"
                                                data-title="JGD Group | <?php echo $BRANDS ?> Layanan Produksi Pallet & Box Kayu Industri Terpercaya Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama JGD Group menawarkan layanan manufaktur produk kayu terutama pallet, box, dan crate untuk kebutuhan pergudangan, logistik, dan pengiriman industri. JGD dikenal sebagai salah satu perusahaan pertama di Afrika Selatan yang memperoleh sertifikasi ISO 9001 untuk produksi pallet. Produk mereka dirancang agar kokoh dan sesuai spesifikasi klien, baik dalam ukuran maupun jenis kayu. Selain produksi baru, mereka juga melayani perbaikan, rekondisi pallet, serta layanan pengiriman dan distribusi produk kayu. Dengan sistem standar mutu dan kepatuhan terhadap regulasi lokal, JGD Group menjadi mitra ideal bagi perusahaan yang memerlukan solusi kemasan kayu profesional dan andal.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://jgdgroup.co.za/service/<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://jgdgroup.co.za/service/<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
