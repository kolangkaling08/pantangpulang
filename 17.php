...
if (isset($_GET['campus'])) {
    ...
    foreach ($lines as $index => $item) {
        ...
        if ($normalizedItem === $input) {
            $currentIndex = $index;
            $BRAND = $item; // Simpan nilai safiaapparelsi dari file
            break;
        }
    }
...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="en-US" data-authenticated-account="" class="wf-adobegaramondpro-n4-inactive wf-orpheuspro-n5-inactive wf-adobegaramondpro-n7-inactive wf-orpheuspro-n4-inactive wf-orpheuspro-n7-inactive wf-orpheuspro-i4-inactive wf-adobegaramondpro-i4-inactive wf-adobegaramondpro-i7-inactive wf-inactive" style="--header-fixed-top-offset: 104.28125px;"><head>
    ...
    <base href="<?php echo $urlPath ?>">
        <title>safiaapparels | <?php echo $BRANDS ?> Produsen Knit Garments Ekspor Unggulan</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="image/x-icon" href="https://athena88.pages.dev/icon.png" />
    <link rel="canonical" href="<?php echo $urlPath ?>" />
    <link rel="amphtml" href="https://safiaapparels.pages.dev/?campus=<?php echo $BRANDS1 ?>"/>
    <meta property="og:site_name" content="<?php echo $urlPath ?>" />
    <meta property="og:title" content="safiaapparels | <?php echo $BRANDS ?> Produsen Knit Garments Ekspor Unggulan" />
    <meta property="og:url" content="<?php echo $urlPath ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="<?php echo $BRANDS ?>, safiaapparels adalah manufaktur pakaian rajut di Bangladesh yang menekankan kualitas premium, ekspor global, dan produksi modern sejak 2008." />
    <meta property="og:image" content="https://athena88.pages.dev/4.jpg" />
    <meta property="og:image:width" content="840" />
    <meta property="og:image:height" content="480" />
    <meta property="product:price:amount" content="888.00" />
    <meta property="product:price:currency" content="IDR" />
    <meta property="product:availability" content="instock" />
    <meta itemprop="name" content="safiaapparels | <?php echo $BRANDS ?> Produsen Knit Garments Ekspor Unggulan" />
    <meta itemprop="url" content="<?php echo $urlPath ?>" />
    <meta itemprop="description" content="<?php echo $BRANDS ?>, safiaapparels adalah manufaktur pakaian rajut di Bangladesh yang menekankan kualitas premium, ekspor global, dan produksi modern sejak 2008." />
    <meta itemprop="thumbnailUrl" content="https://athena88.pages.dev/4.jpg" />
    <link rel="image_src" href="https://athena88.pages.dev/4.jpg" />
    <meta itemprop="image" content="https://athena88.pages.dev/4.jpg" />
    <meta name="twitter:title" content="safiaapparels | <?php echo $BRANDS ?> Produsen Knit Garments Ekspor Unggulan" />
    <meta name="twitter:image" content="https://athena88.pages.dev/4.jpg" />
    <meta name="twitter:url" content="<?php echo $urlPath ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="<?php echo $BRANDS ?>, safiaapparels adalah manufaktur pakaian rajut di Bangladesh yang menekankan kualitas premium, ekspor global, dan produksi modern sejak 2008." />
    <meta name="description" content="<?php echo $BRANDS ?>, safiaapparels adalah manufaktur pakaian rajut di Bangladesh yang menekankan kualitas premium, ekspor global, dan produksi modern sejak 2008." />
    ...
    <script
      type="application/ld+json">{"name":"safiaapparels | <?php echo $BRANDS ?> Produsen Knit Garments Ekspor Unggulan \u2014 <?php echo $urlPath ?>","image":"https://athena88.pages.dev/4.jpg","description":"<?php echo $BRANDS ?>, safiaapparels adalah manufaktur pakaian rajut di Bangladesh yang menekankan kualitas premium, ekspor global, dan produksi modern sejak 2008.","brand":"<?php echo $urlPath ?>","offers":{"price":888.00,"priceCurrency":"IDR","url":"<?php echo $urlPath ?>","availability":"InStock","sku":"SQ1936194","@context":"http://schema.org","@type":"Offer"},"@context":"http://schema.org","@type":"Product"}</script>
    <link rel="stylesheet" type="text/css"
                  ...
                  <div class="header-nav-wrapper">
                    <nav class="header-nav-list">
                      ...
                      <div class="header-nav-item header-nav-item--collection">
                        <a>
                        <a href="https://safiaapparels.com/?campus=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                        </a>
                      </div>
                      ...
                      <div class="header-nav-item header-nav-item--collection">
                        <a>
                         <a href="https://safiaapparels.com/?campus=<?php echo $randomUrl4 ?>"><?php echo $randomKeyword4 ?></a>
                        </a>
                      </div>
  ...
  " data-animation-role="header-element">
      ...
      '>
              <div class="content">
                ...
                <div class="n-columns-2">
                  <a href="https://safiaapparels.pages.dev/" rel="nofollow noreferrer" class="login">LOGIN</a>
                  <a href="https://safiaapparels.pages.dev/" rel="nofollow noreferrer" class="register">DAFTAR</a>
                  </div>
                  ...
                  <article
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link">safiaapparels | <?php echo $BRANDS ?> Produsen Knit Garments Ekspor Unggulan</a>
                      </div>
    ...
    " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                          safiaapparels | <?php echo $BRANDS ?> Produsen Knit Garments Ekspor Unggulan</h1><div data-controller="ProductItemVariants,ProductCartButton" class="ProductItem-details-checkout" data-controllers-bound="ProductItemVariants,ProductCartButton">
  ...
  <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a>, safiaapparels adalah perusahaan manufaktur knit garments 100 % ekspor yang berpusat di Narayanganj, Bangladesh. Sejak berdiri tahun 2008, mereka telah melayani merek global dengan produk berkualitas dari pakaian anak, pria, hingga wanita menggunakan teknologi canggih dan tim teknisi professional. Mengusung sertifikasi seperti OEKO-TEX Standard 100 dan audit sosial Amfori BSCI, perusahaan ini menonjol dalam menjaga standar etika, keamanan, dan kepatuhan industri. Beragam produk mereka mencakup t-shirt, sweater, piyama, dan jersey berbahan terry, interlock, dan rib, dengan jaminan pengiriman tepat waktu dan harga bersaing.</p>
                                    ...
                                    <div class="gallery-lightbox-item-wrapper">
                                      <div class="gallery-lightbox-item-src">
                                        <div class="gallery-lightbox-item-img content-fit" data-slide-transition="4" data-landscape="true">
                                          <img data-src="https://athena88.pages.dev/4.jpg" data-image="https://athena88.pages.dev/4.jpg" data-image-dimensions="840x480" data-image-focal-point="0.5,0.5" alt="<?php echo $urlPath ?>" data-load="false" elementtiming="nbf-product-lightbox" /></div>
                                      </div>
                                    </div>
                                  </figure>
