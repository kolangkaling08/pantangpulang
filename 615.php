...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://course-aactcv-aatcvs.pages.dev/system/?q=<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title>AACTCV | <?php echo $BRANDS ?> Organisasi Profesional & Kepakaran Spesialis</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan AACTCV berkomitmen meningkatkan kompetensi profesional, penelitian ilmiah, serta kolaborasi antar ahli untuk memperkuat standar keahlian dan etika dalam dunia spesialis modern.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "AACTCV | <?php echo $BRANDS ?> Organisasi Profesional & Kepakaran Spesialis",
  "image": "https://jpterus66.calcufast.xyz/img/jpteruslogo.png",
  "description": "<?php echo $BRANDS ?> dan AACTCV berkomitmen meningkatkan kompetensi profesional, penelitian ilmiah, serta kolaborasi antar ahli untuk memperkuat standar keahlian dan etika dalam dunia spesialis modern.",
  "brand": {
    "@type": "Brand",
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?php echo $BRANDS ?>",
      "item": "https://aactcv-aatcvs.org/course/<?php echo $BRANDS1 ?>"
    },
    {
      "@type": "ListItem",
      "position": 2,
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="AACTCV | <?php echo $BRANDS ?> Organisasi Profesional & Kepakaran Spesialis">
    ...
    <meta name="twitter:title" content="AACTCV | <?php echo $BRANDS ?> Organisasi Profesional & Kepakaran Spesialis">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan AACTCV berkomitmen meningkatkan kompetensi profesional, penelitian ilmiah, serta kolaborasi antar ahli untuk memperkuat standar keahlian dan etika dalam dunia spesialis modern.">
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone">AACTCV | <?php echo $BRANDS ?> Organisasi Profesional & Kepakaran Spesialis</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            AACTCV | <?php echo $BRANDS ?> Organisasi Profesional & Kepakaran Spesialis
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong>AACTCV | <?php echo $BRANDS ?> Organisasi Profesional & Kepakaran Spesialis</strong>
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/jpterus66/"><img
                                                    alt="AACTCV | <?php echo $BRANDS ?> Organisasi Profesional & Kepakaran Spesialis - WooCommerce eCommerce"
                                                    width="300" height="300"
                                                    srcset="https://jpterus66.calcufast.xyz/JPTERUS66/banner-93.png"
                                                    sizes="(min-width: 1024px) 590px, (min-width: 1px) 100vw, 600px"
                                                    src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-93.png"></a>
                                            <div class="js- item-preview-image__gallery"
                                                data-title="AACTCV | <?php echo $BRANDS ?> Organisasi Profesional & Kepakaran Spesialis Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> AACTCV membangun wadah kolaborasi profesional yang berfokus pada pengembangan keahlian, riset ilmiah, dan pertukaran pengetahuan lintas bidang. AACTCV menjadi tempat bagi para ahli dan spesialis untuk memperdalam kompetensi melalui konferensi, seminar, serta publikasi akademik yang kredibel. Organisasi ini menjunjung tinggi etika, inovasi, dan kemajuan profesional sebagai pilar utama dalam setiap aktivitasnya.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://aactcv-aatcvs.org/course/<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://aactcv-aatcvs.org/course/<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
