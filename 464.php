...
function getBrandMeta($brandName) {
    ...
    for ($i = 0; $i < count($lines); $i++) {
        ...
        // cek apakah baris mengandung nama brand
        if (stripos($line, $brandName) !== false) {
            $title = str_replace("BRAND", $brandName, $line); 

            // ambil baris berikutnya sebagai deskripsi (kalau ada)
            if (isset($lines[$i+1]) && stripos($lines[$i+1], "BRAND") === false) {
                $desc = str_replace("BRAND", $brandName, $lines[$i+1]);
            }
            break;
        }
    }
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone"><?php echo $metaTitle ?></h1>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong><?php echo $metaTitle ?></strong>
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="<?php echo $metaTitle ?> - WooCommerce eCommerce"
                                            ...
                                            <div class="js- item-preview-image__gallery"
                                                data-title="<?php echo $metaTitle ?> Hari Ini - WooCommerce eCommerce Screenshots Gallery"
