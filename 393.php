...
<head>
    ...
    <title><?php echo $BRANDS ?> | SGM ISG Layanan Konsultasi Kesehatan dan Keamanan Kerja</title>
    <link rel="amphtml" href="https://consult-sgmisg.pages.dev/?q=<?php echo $BRANDS1 ?>" />
    <meta name="description" content="<?php echo $BRANDS ?> dan SGM ISG mendukung perusahaan dengan konsultasi, pelatihan, serta layanan manajemen risiko di bidang kesehatan dan keselamatan kerja di Turki." itemprop="description" />
    <meta name="originalTitle" content="<?php echo $BRANDS ?> | SGM ISG Layanan Konsultasi Kesehatan dan Keamanan Kerja" />
    <meta charset="utf-8"> 
    <meta property="og:type" content="article" />
    <meta property="og:site_name" content="<?php echo $BRANDS ?>" />
    <meta property="og:title" content="<?php echo $BRANDS ?> | SGM ISG Layanan Konsultasi Kesehatan dan Keamanan Kerja" />
    <meta property="og:image" content="https://justkid.pages.dev/26.png" />
    <meta property="og:description" content="<?php echo $BRANDS ?> dan SGM ISG mendukung perusahaan dengan konsultasi, pelatihan, serta layanan manajemen risiko di bidang kesehatan dan keselamatan kerja di Turki." />
    ...
    <meta content="<?php echo $BRANDS ?> dan SGM ISG mendukung perusahaan dengan konsultasi, pelatihan, serta layanan manajemen risiko di bidang kesehatan dan keselamatan kerja di Turki." itemprop="headline" />
    <meta name="keywords" content="yusuf dikec,olimpiade paris,olimpiade paris 2024" itemprop="keywords" />
    <meta name="thumbnailUrl" content="https://justkid.pages.dev/26.png" itemprop="thumbnailUrl" />
    ...
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan SGM ISG mendukung perusahaan dengan konsultasi, pelatihan, serta layanan manajemen risiko di bidang kesehatan dan keselamatan kerja di Turki." />
    <meta name="twitter:image" content="https://justkid.pages.dev/26.png" />
    ...
    <meta name="dtk:thumbnailUrl" content="https://justkid.pages.dev/26.png" itemprop="thumbnailUrl" />
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "headline": "<?php echo $BRANDS ?> | SGM ISG Layanan Konsultasi Kesehatan dan Keamanan Kerja",
    ...
    <script type="application/ld+json">
        {
            ...
            "description": "<?php echo $BRANDS ?> dan SGM ISG mendukung perusahaan dengan konsultasi, pelatihan, serta layanan manajemen risiko di bidang kesehatan dan keselamatan kerja di Turki."
        }
        </script>
            <script type="application/ld+json">
{
    ...
    <div class="container">
        ...
        <article class="detail">
            ...
            <div class="detail__header">
                ...
                <h1 class="detail__title"><?php echo $BRANDS ?> | SGM ISG Layanan Konsultasi Kesehatan dan Keamanan Kerja</h1>
            ...
            <div class="content">
                ...
                <div class="detail__media">
                    <figure dtr-evt="cover image" dtr-sec="" dtr-act="cover image" onclick="_pt(this)"
                        ...
                        <img src="https://justkid.pages.dev/26.png" alt="Yusuf Dikec"
                ...
                <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama SGM ISG memperkenalkan layanan konsultasi dan pelatihan di bidang kesehatan serta keselamatan kerja. Perusahaan ini membantu organisasi dalam mengelola risiko, memberikan pelatihan keselamatan, serta memastikan kepatuhan terhadap regulasi terkait lingkungan kerja. Dengan tim profesional, SGM ISG mendukung perusahaan agar dapat menciptakan tempat kerja yang lebih aman dan produktif. Fokus mereka adalah menjaga kesejahteraan karyawan sekaligus meningkatkan efisiensi operasional melalui penerapan sistem K3 yang tepat.</p>
                        ...
                        <tr>
                            <td>
                                <div class="lihatjg"><strong>Baca juga: </strong><a data-label="List Berita"
                                        ...
                                        <?php echo $BRANDS ?> | SGM ISG Layanan Konsultasi Kesehatan dan Keamanan Kerja</a></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="sticky-share">
            <div class="detail__share sticky-share__wrap">
                <a dtr-evt="floating komentar" dtr-sec="tombol komentar" dtr-act="tombol komentar" onclick="_pt(this)"
                    ...
                    data-title="<?php echo $BRANDS ?> | SGM ISG Layanan Konsultasi Kesehatan dan Keamanan Kerja"
                    data-image="https://res.cloudinary.com/dlnvwjm0j/image/upload/v1722855586/cocain_eogid1.jpg"
                    data-desc="<?php echo $BRANDS ?> dan SGM ISG mendukung perusahaan dengan konsultasi, pelatihan, serta layanan manajemen risiko di bidang kesehatan dan keselamatan kerja di Turki."
                ...
                getScript("https://awscdn.detik.net.id/libs/comment/v2/js/zoid.min.js?2024080215", function () {
                    getScript("https://awscdn.detik.net.id/libs/comment/v2/js/bridge.js?2024080215", function () {
                        ...
                        CommentComponent({
                            ...
                            kanal: 398,
                            date: "02-08-2024",
                            title: "<?php echo $BRANDS ?> | SGM ISG Layanan Konsultasi Kesehatan dan Keamanan Kerja",
                            clientId: 98,
                            prefix: "dtk",
                            prokontra: 0,
                            pembukaDiskusi: "",
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="1"
                                ...
                                href="https://sgmisg.com.tr/consult/?q=<?php echo $randomUrl ?>" class="media__link"><?php echo $randomKeyword ?></a>
                        </h3>
                    </div>
                </div>
            </article>
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="2"
                                ...
                                href="https://sgmisg.com.tr/consult/?q=<?php echo $randomUrl2 ?>" class="media__link"><?php echo $randomKeyword2 ?></a>
                        </h3>
                    </div>
                </div>
            </article>
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="3"
                                dtr-id="7469546"
                                dtr-ttl="<?php echo $randomKeyword3 ?>" href="https://sgmisg.com.tr/consult/?q=<?php echo $randomUrl3 ?>"
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="4"
                                dtr-id="7470202"
                                dtr-ttl="<?php echo $randomKeyword4 ?>" href="https://sgmisg.com.tr/consult/?q=<?php echo $randomUrl4 ?>"
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="5"
                                ...
                                href="https://sgmisg.com.tr/consult/?q=<?php echo $randomUrl5 ?>" class="media__link"><?php echo $randomKeyword5 ?></a>
                        </h3>
                    </div>
                </div>
            </article>
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="6"
                                ...
                                href="https://sgmisg.com.tr/consult/?q=<?php echo $randomUrl6 ?>" class="media__link"><?php echo $randomKeyword6 ?></a>
                        </h3>
                    </div>
                </div>
            </article>
