...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://portal-lets-cidaap.pages.dev/?q=<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title><?php echo $BRANDS ?> - CiDAAP Portal Konferensi & Workshop Vascular Access</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan CiDAAP Portal menghadirkan konferensi terapi akses vaskular (CiDAAP 6.0) di Gurugram dengan pembicara global, workshop interaktif, studi kasus, serta teknologi intervensi terbaru.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "<?php echo $BRANDS ?> - CiDAAP Portal Konferensi & Workshop Vascular Access",
  "image": "https://athena88.pages.dev/logo-1.png",
  "description": "<?php echo $BRANDS ?> dan CiDAAP Portal menghadirkan konferensi terapi akses vaskular (CiDAAP 6.0) di Gurugram dengan pembicara global, workshop interaktif, studi kasus, serta teknologi intervensi terbaru.",
  "brand": {
    "@type": "Brand",
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="<?php echo $BRANDS ?> - CiDAAP Portal Konferensi & Workshop Vascular Access">
    ...
    <meta name="twitter:title" content="<?php echo $BRANDS ?> - CiDAAP Portal Konferensi & Workshop Vascular Access">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan CiDAAP Portal menghadirkan konferensi terapi akses vaskular (CiDAAP 6.0) di Gurugram dengan pembicara global, workshop interaktif, studi kasus, serta teknologi intervensi terbaru.">
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone"><?php echo $BRANDS ?> - CiDAAP Portal Konferensi & Workshop Vascular Access</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            <?php echo $BRANDS ?> - CiDAAP Portal Konferensi & Workshop Vascular Access
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong><?php echo $BRANDS ?> - CiDAAP Portal Konferensi & Workshop Vascular Access</strong>
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="<?php echo $BRANDS ?> - CiDAAP Portal Konferensi & Workshop Vascular Access - WooCommerce eCommerce"
                                            ...
                                            <div class="js- item-preview-image__gallery"
                                                data-title="<?php echo $BRANDS ?> - CiDAAP Portal Konferensi & Workshop Vascular Access Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                            ...
                                            <div id="purchase-form" class="purchase-form" bis_skin_checked="1">
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                        ...
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama CiDAAP Portal menghadirkan konferensi medis internasional “Let’s CiDAAP 6.0” yang berlangsung 20–21 Desember 2024 di Gurugram. Tema “Changing Paradigms – Navigating Vascular Health Together” ditekankan melalui jurnal intervensi endovaskular terbaru. Portal ini memfasilitasi peserta akses ke registrasi, program ilmiah, keynote, panel diskusi, serta hands-on workshop dengan teknologi seperti mechanical thrombectomy. Platform ini menjadi pusat interaksi antara profesional kesehatan, peneliti, dan inovator medis dalam pengembangan akses vaskular modern.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://lets-cidaap.com/portal/?q=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://lets-cidaap.com/portal/?q=<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
