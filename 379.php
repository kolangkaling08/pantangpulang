...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://portal-sit-nassadepok.pages.dev/?q=<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title><?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan SMPIT Tunas Bangsa Depok menyediakan LMS inovatif untuk mendukung proses belajar mengajar digital, interaktif, dan efektif bagi siswa dan guru.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "<?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu",
  "image": "https://justkid.pages.dev/logo.png",
  "description": "<?php echo $BRANDS ?> dan SMPIT Tunas Bangsa Depok menyediakan LMS inovatif untuk mendukung proses belajar mengajar digital, interaktif, dan efektif bagi siswa dan guru.",
  "brand": {
    "@type": "Brand",
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="<?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu">
    <meta property="og:description"
        content="<?php echo $BRANDS ?> dan SMPIT Tunas Bangsa Depok menyediakan LMS inovatif untuk mendukung proses belajar mengajar digital, interaktif, dan efektif bagi siswa dan guru.">
    <meta property="og:image" content="https://justkid.pages.dev/15.png">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:type" content="website">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan SMPIT Tunas Bangsa Depok menyediakan LMS inovatif untuk mendukung proses belajar mengajar digital, interaktif, dan efektif bagi siswa dan guru.">
    <meta name="twitter:image" content="https://justkid.pages.dev/15.png">
    <meta property="og:title" content="<?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:image" content="https://justkid.pages.dev/15.png" />
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone"><?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            <?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong><?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu</strong>
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="<?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu - WooCommerce eCommerce"
                                                    width="300" height="300"
                                                    srcset="https://justkid.pages.dev/15.png"
                                                    sizes="(min-width: 1024px) 590px, (min-width: 1px) 100vw, 600px"
                                                    src="https://justkid.pages.dev/15.png"></a>
                                            <div class="js- item-preview-image__gallery"
                                                data-title="<?php echo $BRANDS ?> | SMPIT Tunas Bangsa Depok LMS Pembelajaran Digital Terpadu Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama SMPIT Tunas Bangsa Depok menghadirkan platform Learning Management System (LMS) modern untuk mendukung pembelajaran digital. Melalui LMS ini, siswa dapat mengakses materi pelajaran, mengikuti ujian online, mengumpulkan tugas, serta berinteraksi dengan guru dan teman sekelas secara virtual. Guru juga memanfaatkan LMS untuk memberikan umpan balik, memantau kemajuan belajar siswa, dan mengelola tugas dengan efisien. SMPIT Tunas Bangsa Depok menggabungkan nilai-nilai Islami dengan pendekatan pendidikan modern, menciptakan lingkungan belajar yang inovatif dan interaktif.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://lms.smp.sit-nassadepok.sch.id/portal/?q=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://lms.smp.sit-nassadepok.sch.id/portal/?q=<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
