...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://service-aliexim.pages.dev/<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title>Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan Ali Exim menyediakan layanan ekspor-impor profesional, produk unggulan bersertifikasi, jaringan distribusi global, dan keandalan tinggi untuk pelanggan bisnis internasional.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional",
  "image": "https://justkid.pages.dev/logo.png",
  "description": "<?php echo $BRANDS ?> dan Ali Exim menyediakan layanan ekspor-impor profesional, produk unggulan bersertifikasi, jaringan distribusi global, dan keandalan tinggi untuk pelanggan bisnis internasional.",
  "brand": {
    "@type": "Brand",
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?php echo $BRANDS ?>",
      "item": "https://aliexim.co.in/service/<?php echo $BRANDS1 ?>"
    },
    {
      "@type": "ListItem",
      "position": 2,
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional">
    <meta property="og:description"
        content="<?php echo $BRANDS ?> dan Ali Exim menyediakan layanan ekspor-impor profesional, produk unggulan bersertifikasi, jaringan distribusi global, dan keandalan tinggi untuk pelanggan bisnis internasional.">
    <meta property="og:image" content="https://justkid.pages.dev/69.png">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:type" content="website">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan Ali Exim menyediakan layanan ekspor-impor profesional, produk unggulan bersertifikasi, jaringan distribusi global, dan keandalan tinggi untuk pelanggan bisnis internasional.">
    <meta name="twitter:image" content="https://justkid.pages.dev/69.png">
    <meta property="og:title" content="Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo $urlPath ?>">
    <meta property="og:image" content="https://justkid.pages.dev/69.png" />
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone">Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong>Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional</strong>
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional - WooCommerce eCommerce"
                                                    width="300" height="300"
                                                    srcset="https://justkid.pages.dev/69.png"
                                                    sizes="(min-width: 1024px) 590px, (min-width: 1px) 100vw, 600px"
                                                    src="https://justkid.pages.dev/69.png"></a>
                                            <div class="js- item-preview-image__gallery"
                                                data-title="Ali Exim | <?php echo $BRANDS ?> Eksport Impor Produk Ternama & Keunggulan Internasional Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama Ali Exim menawarkan keahlian dalam bidang ekspor dan impor barang bagi pelaku usaha yang memerlukan solusi lintas negara. Fokus utama perusahaan ini adalah menjaga standar kualitas produk, kepatuhan regulasi perdagangan internasional, dan kecepatan pengiriman agar barang sampai tepat waktu dan aman. Ali Exim mendukung pelanggannya melalui manajemen logistik, dokumentasi ekspor-impor, dan penyediaan produk yang sesuai kebutuhan pasar global. Pelayanan pelanggan yang responsif serta reputasi pada reliability dalam rantai pasokan menjadi nilai tambah yang membuat Ali Exim dipercaya oleh klien yang ingin memperluas bisnis mereka di luar negeri.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://aliexim.co.in/service/<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://aliexim.co.in/service/<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
