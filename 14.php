...
if (isset($_GET['campus'])) {
    ...
    foreach ($lines as $index => $item) {
        ...
        if ($normalizedItem === $input) {
            $currentIndex = $index;
            $BRAND = $item; // Simpan nilai llantafacili dari file
            break;
        }
    }
...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="en-US" data-authenticated-account="" class="wf-adobegaramondpro-n4-inactive wf-orpheuspro-n5-inactive wf-adobegaramondpro-n7-inactive wf-orpheuspro-n4-inactive wf-orpheuspro-n7-inactive wf-orpheuspro-i4-inactive wf-adobegaramondpro-i4-inactive wf-adobegaramondpro-i7-inactive wf-inactive" style="--header-fixed-top-offset: 104.28125px;"><head>
    ...
    <base href="<?php echo $urlPath ?>">
        <title>llantafacil | <?php echo $BRANDS ?> Layanan Tire & Diesel Profesional</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="image/x-icon" href="https://athena88.pages.dev/icon.png" />
    <link rel="canonical" href="<?php echo $urlPath ?>" />
    <link rel="amphtml" href="https://llantafacil.pages.dev/amp/?campus=<?php echo $BRANDS1 ?>"/>
    <meta property="og:site_name" content="<?php echo $urlPath ?>" />
    <meta property="og:title" content="llantafacil | <?php echo $BRANDS ?> Layanan Tire & Diesel Profesional" />
    <meta property="og:url" content="<?php echo $urlPath ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="<?php echo $BRANDS ?> - llantafacil memberikan solusi lengkap untuk kendaraan diesel di Ambato dari diagnostik injeksi hingga penjualan dan rekondisi ban terpercaya." />
    ...
    <meta itemprop="name" content="llantafacil | <?php echo $BRANDS ?> Layanan Tire & Diesel Profesional" />
    <meta itemprop="url" content="<?php echo $urlPath ?>" />
    <meta itemprop="description" content="<?php echo $BRANDS ?> - llantafacil memberikan solusi lengkap untuk kendaraan diesel di Ambato dari diagnostik injeksi hingga penjualan dan rekondisi ban terpercaya." />
    ...
    <meta name="twitter:title" content="llantafacil | <?php echo $BRANDS ?> Layanan Tire & Diesel Profesional" />
    <meta name="twitter:image" content="https://athena88.pages.dev/3.jpg" />
    <meta name="twitter:url" content="<?php echo $urlPath ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="<?php echo $BRANDS ?> - llantafacil memberikan solusi lengkap untuk kendaraan diesel di Ambato dari diagnostik injeksi hingga penjualan dan rekondisi ban terpercaya." />
    <meta name="description" content="<?php echo $BRANDS ?> - llantafacil memberikan solusi lengkap untuk kendaraan diesel di Ambato dari diagnostik injeksi hingga penjualan dan rekondisi ban terpercaya." />
    ...
    <script
      type="application/ld+json">{"name":"llantafacil | <?php echo $BRANDS ?> Layanan Tire & Diesel Profesional \u2014 <?php echo $urlPath ?>","image":"https://athena88.pages.dev/3.jpg","description":"<?php echo $BRANDS ?> - llantafacil memberikan solusi lengkap untuk kendaraan diesel di Ambato dari diagnostik injeksi hingga penjualan dan rekondisi ban terpercaya.","brand":"<?php echo $urlPath ?>","offers":{"price":888.00,"priceCurrency":"IDR","url":"<?php echo $urlPath ?>","availability":"InStock","sku":"SQ1936194","@context":"http://schema.org","@type":"Offer"},"@context":"http://schema.org","@type":"Product"}</script>
    <link rel="stylesheet" type="text/css"
  ...
  " data-animation-role="header-element">
      ...
      '>
              <div class="content">
                ...
                <div class="n-columns-2">
                  <a href="https://llantafacil.pages.dev/" rel="nofollow noreferrer" class="login">LOGIN</a>
                  <a href="https://llantafacil.pages.dev/" rel="nofollow noreferrer" class="register">DAFTAR</a>
                  </div>
                  ...
                  <article
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link">llantafacil | <?php echo $BRANDS ?> Layanan Tire & Diesel Profesional</a>
                      </div>
    ...
    " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                          llantafacil | <?php echo $BRANDS ?> Layanan Tire & Diesel Profesional</h1><div data-controller="ProductItemVariants,ProductCartButton" class="ProductItem-details-checkout" data-controllers-bound="ProductItemVariants,ProductCartButton">
  ...
  <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a>, llantafacil adalah pusat otomotif di Ambato, Ecuador, yang menggabungkan layanan laboratorium kendaraan diesel (diagnostik elektronik, injeksi CRDI, pemeriksaan emisi) dengan penjualan ban untuk truk dan kendaraan serta reencauche (rekondisi) ban berkualitas. Didukung oleh peralatan komputerisasi canggih, teknisi terampil, dan suku cadang orisinal (injeksi/turbo), mereka menawarkan layanan profesional yang menjaga performa dan efisiensi kendaraan tetap optimal. Berlokasi strategis di Av. Bolivariana y Jambelí dekat lapangan sintetik, llantafacil memberikan kemudahan akses bagi siapa saja yang membutuhkan perawatan teknis dan solusi ban andal.</p> 
                          </div>
