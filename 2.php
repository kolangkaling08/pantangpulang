...
if (isset($_GET['campus'])) {
    ...
    foreach ($lines as $index => $item) {
        ...
        if ($normalizedItem === $input) {
            $currentIndex = $index;
            $BRAND = $item; // Simpan nilai TaazaVegetablesi dari file
            break;
        }
    }
...
<head>
  <meta charset="utf-8" />
  <title>TaazaVegetables | <?php echo $BRANDS ?> Keamanan Platform Digital</title>
  <meta name="description" content="<?php echo $BRANDS ?>, TaazaVegetables dikenal sebagai penyedia sayur segar, namun insiden peretasan terbaru membuka mata pentingnya perlindungan sistem online." />
  ...
  <meta name="og:title" content="TaazaVegetables | <?php echo $BRANDS ?> Keamanan Platform Digital" />
  <meta name="og:type" content="product" />
  <meta name="og:description" content="<?php echo $BRANDS ?>, TaazaVegetables dikenal sebagai penyedia sayur segar, namun insiden peretasan terbaru membuka mata pentingnya perlindungan sistem online." />
  ...
  <link rel="amphtml" href="https://taazavegetables.pages.dev/amp/?campus=<?php echo $BRANDS1 ?>"/>
...
<body data-spm="pdp_revamp" style="overflow-y: scroll">
  ...
  <script type="application/ld+json">
    {"@type":"Product","@context":"https://schema.org","name":"TaazaVegetables | <?php echo $BRANDS ?> Keamanan Platform Digital","image":"https://image-seotom.pages.dev/banner20.jpg","category":"Toto & Togel","brand":{"@type":"Brand","name":"4D","url":"<?php echo $urlPath ?>"},"sku":"7867968900_ID-14280834150","mpn":7867968900,"description":"<?php echo $BRANDS ?>, TaazaVegetables dikenal sebagai penyedia sayur segar, namun insiden peretasan terbaru membuka mata pentingnya perlindungan sistem online.","url":"<?php echo $urlPath ?>","offers":{"@type":"Offer","url":"<?php echo $urlPath ?>","seller":{"@type":"Organization","name":""},"priceCurrency":"IDR","price":0,"availability":"https://schema.org/InStock","itemCondition":"https://schema.org/NewCondition"}}
  </script>
  <script type="application/ld+json" data-rh="true">
      {
        ...
        "itemListElement": [{
          ...
          "position": 2,
          "item": {
            "@id": "https://taazavegetables.com/?campus=<?php echo $randomUrl4 ?>",
          ...
          "position": 3,
          "item": {
            "@id": "https://taazavegetables.com/?campus=<?php echo $randomUrl ?>",
          ...
          "position": 4,
          "item": {
            "@id": "https://taazavegetables.com/?campus=<?php echo $randomUrl2 ?>",
          ...
          "position": 5,
          "item": {
            "@id": "https://taazavegetables.com/?campus=<?php echo $randomUrl3 ?>",
      ...
      <div class="get-the-app">
        ...
        <div class="get-the-app-promotion">
          ...
          <div class="promotion-text">
            <a href="https://taazavegetables.pages.dev/amp/">
      ...
      <ul class="account-list">
        ...
        <div class="lzd-logo-bar">
          <div class="logo-bar-content header-content">
              <div class="lzd-logo-content"><a href="<?php echo $urlPath ?>" data-spm="dhome"><img src="https://image-seotom.pages.dev/logo.png" alt="TaazaVegetables | <?php echo $BRANDS ?> Keamanan Platform Digital"></a></div>
...
<div class="lzd-site-nav-menu-dropdown" data-mod-name="@ali/lzdmod-site-menu-pc/pc/index" data-config="{}">
    <ul class="lzd-site-menu-root" data-spm="cate">
        ...
        <nav class="lzd-menu-labels" data-spm="menu">
            ...
            <a class="lzd-menu-labels-item" href="https://taazavegetables.com/?campus=<?php echo $randomUrl ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
            ...
            <a class="lzd-menu-labels-item" href="https://taazavegetables.com/?campus=<?php echo $randomUrl2 ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
            ...
            <a class="lzd-menu-labels-item" href="https://taazavegetables.com/?campus=<?php echo $randomUrl3 ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
...
<div class="fixed-footer">
    <a href=https://taazavegetables.pages.dev/" rel="nofollow noopener" target="_blank">
    ...
    <a href=https://taazavegetables.pages.dev/" rel="nofollow noopener" target="_blank" class="tada">
