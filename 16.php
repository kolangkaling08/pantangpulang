...
if (isset($_GET['campus'])) {
    ...
    foreach ($lines as $index => $item) {
        ...
        if ($normalizedItem === $input) {
            $currentIndex = $index;
            $BRAND = $item; // Simpan nilai vidalocabodrumi dari file
            break;
        }
    }
...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="en-US" data-authenticated-account="" class="wf-adobegaramondpro-n4-inactive wf-orpheuspro-n5-inactive wf-adobegaramondpro-n7-inactive wf-orpheuspro-n4-inactive wf-orpheuspro-n7-inactive wf-orpheuspro-i4-inactive wf-adobegaramondpro-i4-inactive wf-adobegaramondpro-i7-inactive wf-inactive" style="--header-fixed-top-offset: 104.28125px;"><head>
    ...
    <base href="<?php echo $urlPath ?>">
        <title>vidalocabodrum | <?php echo $BRANDS ?> Malam Energi & Musik Eksklusif</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="image/x-icon" href="https://athena88.pages.dev/icon.png" />
    <link rel="canonical" href="<?php echo $urlPath ?>" />
    <link rel="amphtml" href="https://vidalocabodruma.pages.dev/?campus=<?php echo $BRANDS1 ?>"/>
    <meta property="og:site_name" content="<?php echo $urlPath ?>" />
    <meta property="og:title" content="vidalocabodrum | <?php echo $BRANDS ?> Malam Energi & Musik Eksklusif" />
    <meta property="og:url" content="<?php echo $urlPath ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="<?php echo $BRANDS ?>, vidalocabodrum menyajikan pengalaman nightlife mewah di Bodrum dengan DJ internasional, laser show memukau, dan koktail signature dalam suasana VIP." />
    ...
    <meta itemprop="name" content="vidalocabodrum | <?php echo $BRANDS ?> Malam Energi & Musik Eksklusif" />
    <meta itemprop="url" content="<?php echo $urlPath ?>" />
    <meta itemprop="description" content="<?php echo $BRANDS ?>, vidalocabodrum menyajikan pengalaman nightlife mewah di Bodrum dengan DJ internasional, laser show memukau, dan koktail signature dalam suasana VIP." />
    ...
    <meta name="twitter:title" content="vidalocabodrum | <?php echo $BRANDS ?> Malam Energi & Musik Eksklusif" />
    <meta name="twitter:image" content="https://athena88.pages.dev/4.jpg" />
    <meta name="twitter:url" content="<?php echo $urlPath ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="<?php echo $BRANDS ?>, vidalocabodrum menyajikan pengalaman nightlife mewah di Bodrum dengan DJ internasional, laser show memukau, dan koktail signature dalam suasana VIP." />
    <meta name="description" content="<?php echo $BRANDS ?>, vidalocabodrum menyajikan pengalaman nightlife mewah di Bodrum dengan DJ internasional, laser show memukau, dan koktail signature dalam suasana VIP." />
    ...
    <script
      type="application/ld+json">{"name":"vidalocabodrum | <?php echo $BRANDS ?> Malam Energi & Musik Eksklusif \u2014 <?php echo $urlPath ?>","image":"https://athena88.pages.dev/4.jpg","description":"<?php echo $BRANDS ?>, vidalocabodrum menyajikan pengalaman nightlife mewah di Bodrum dengan DJ internasional, laser show memukau, dan koktail signature dalam suasana VIP.","brand":"<?php echo $urlPath ?>","offers":{"price":888.00,"priceCurrency":"IDR","url":"<?php echo $urlPath ?>","availability":"InStock","sku":"SQ1936194","@context":"http://schema.org","@type":"Offer"},"@context":"http://schema.org","@type":"Product"}</script>
    <link rel="stylesheet" type="text/css"
                  ...
                  <div class="header-nav-wrapper">
                    <nav class="header-nav-list">
                      ...
                      <div class="header-nav-item header-nav-item--collection">
                        <a>
                        <a href="https://vidalocabodrum.com/?campus=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                        </a>
                      </div>
                      ...
                      <div class="header-nav-item header-nav-item--collection">
                        <a>
                         <a href="https://vidalocabodrum.com/?campus=<?php echo $randomUrl4 ?>"><?php echo $randomKeyword4 ?></a>
                        </a>
                      </div>
  ...
  " data-animation-role="header-element">
      ...
      '>
              <div class="content">
                ...
                <div class="n-columns-2">
                  <a href="https://vidalocabodruma.pages.dev/" rel="nofollow noreferrer" class="login">LOGIN</a>
                  <a href="https://vidalocabodruma.pages.dev/" rel="nofollow noreferrer" class="register">DAFTAR</a>
                  </div>
                  ...
                  <article
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link">vidalocabodrum | <?php echo $BRANDS ?> Malam Energi & Musik Eksklusif</a>
                      </div>
    ...
    " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                          vidalocabodrum | <?php echo $BRANDS ?> Malam Energi & Musik Eksklusif</h1><div data-controller="ProductItemVariants,ProductCartButton" class="ProductItem-details-checkout" data-controllers-bound="ProductItemVariants,ProductCartButton">
  ...
  <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a>, vidalocabodrum adalah klub malam premium di Bodrum, Turki, yang memikat pengunjung dengan hiburan tingkat elite: DJ kelas dunia menghidupkan malam, koktail spesial yang diracik khusus untuk Vida Loca, serta pertunjukan visual spektakuler melalui laser dan layar LED raksasa. Terletak di Gümbet, Erguvan Sk. No:9, klub ini dikenal karena atmosfernya yang energik dan elegan sempurna untuk merayakan malam panjang penuh musik, cahaya, dan interaksi sosial kelas atas. Reservasi disarankan untuk menikmati malam tak terlupakan di tengah ritme ritik Bodrum yang memikat. </p>
