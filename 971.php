...
<head>
    ...
    <title>PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP</title>
    <meta name="description"
        content="<?php echo $BRANDS ?> dan PPDB SMPN 172 JKT menyediakan platform belajar interaktif dengan materi kurikulum SMP, kuis, latihan, dan ujian untuk mendukung proses belajar siswa.">
    ...
    <script type="application/ld+json">
        ...
        "name": "PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP",
        "sku": "1479848303",
        "gtin": "n\/a",
        "description": "<?php echo $BRANDS ?> dan PPDB SMPN 172 JKT menyediakan platform belajar interaktif dengan materi kurikulum SMP, kuis, latihan, dan ujian untuk mendukung proses belajar siswa.",
        "image": [{
          "@type": "ImageObject",
          "@context": "https:\/\/schema.org",
        ...
        "category": "PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP",
        "brand": {
          "@type": "Slot Gacor",
          "@context": "https:\/\/schema.org",
          "name": "Slot Gacor"
    ...
    <meta property="og:title"
        content="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP">
    <meta property="og:description"
        content="<?php echo $BRANDS ?> dan PPDB SMPN 172 JKT menyediakan platform belajar interaktif dengan materi kurikulum SMP, kuis, latihan, dan ujian untuk mendukung proses belajar siswa.">
    <meta property="og:type" content="product" />
    <meta property="og:url" content="<?php echo $urlPath ?>" />
    <meta property="og:image" content="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
    ...
    <link rel="amphtml" href="https://course-e-learning-smpn172jkt.pages.dev/system/?q=<?php echo $BRANDS1 ?>" />
    <link rel="preconnect" href="//i.etsystatic.com" crossorigin="anonymous" />
    <link rel="preconnect" href="//i.etsystatic.com" />
    <link rel="preconnect" href="//v.etsystatic.com" />
    <link rel="preconnect" href="//v.etsystatic.com" crossorigin="anonymous" />
    <link rel="preload" as="image" imagesrcset="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" fetchpriority="high" />
      ...
      Daftar
                ...
                show-scrollable-thumbnails">
                                                <ul class="wt-list-unstyled wt-overflow-hidden wt-position-relative carousel-pane-list"
                                                    ...
                                                    <li class=" wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                        ...
                                                        <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 1" data-carousel-first-image data-perf-group="main-product-image" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" srcset="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png 1x, https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png 2x" fetchpriority="high" data-original-image-width="2000" data-src-zoom-image="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-index="0" />
                                                    </li>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 2 20 20" aria-hidden="true" focusable="false">
                                          <polygon points="4 4 4 20 20 12 4 4" />
                                                    ...
                                                    <li class="wt-display-none  wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                        ...
                                                        data-palette-listing-image>
                                                        <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 2" loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-index="2" />
                                                    </li>
                                                    <li class="wt-display-none  wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                        data-carousel-pane data-index="3" data-image-id="4944896555"
                                                        data-palette-listing-image>
                                                        <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 3" loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-index="3" />
                                                    </li>
                                                    <li class="wt-display-none  wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                        data-carousel-pane data-index="4" data-image-id="4896625408"
                                                        data-palette-listing-image>
                                                        <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 4" loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-index="4" />
                                                    </li>
                                                    <li class="wt-display-none  wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                        data-carousel-pane data-index="5" data-image-id="6523296081"
                                                        data-palette-listing-image>
                                                        <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 5" loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-index="5" />
                                                    </li>
                                                    <li class="wt-display-none  wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                        data-carousel-pane data-index="6" data-image-id="6475188790"
                                                        data-palette-listing-image>
                                                        <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 6" loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-index="6" />
                                                    </li>
                                                    <li class="wt-display-none  wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                        data-carousel-pane data-index="7" data-image-id="4896625410"
                                                        data-palette-listing-image>
                                                        <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 7" loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-index="7" />
                                                    </li>
                                                    <li class="wt-display-none  wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                        data-carousel-pane data-index="8" data-image-id="4944896563"
                                                        data-palette-listing-image>
                                                        <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 8" loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-index="8" />
                                                    </li>
                                                    <li class="wt-display-none  wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                        data-carousel-pane data-index="9" data-image-id="4944896543"
                                                        data-palette-listing-image>
                                                        <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 9" loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" srcset="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png 1x, https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png 2x" data-perf-group="secondary-product-image" data-original-image-width="2000" data-src-zoom-image="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-index="9" />
                                                    </li>
                                                </ul>
                ...
                wt-order-xs-1 wt-flex-direction-column-xs wt-align-items-flex-end">
                                                        <li data-carousel-pagination-item data-index="0"
                                                            ...
                                                            tabindex="0">
                                                            <img class="wt-animated wt-display-none wt-max-width-full" src="" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 1" data-carousel-thumbnail-image data-src-delay="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" aria-label="product image 1 of 9" data-should-fade-in-on-load="true" />
                                                        </li>
                                    ...
                                    <path d="M8,21a1,1,0,0,1-.664-1.747L15.5,12,7.336,4.747A1,1,0,0,1,8.664,3.253L18.5,12,8.664,20.747A0.994,0.994,0,0,1,8,21Z" />
                                                        ...
                                                        <ul class="wt-list-unstyled wt-overflow-hidden image-overlay-list wt-position-relative wt-vertical-center wt-display-flex-xs wt-justify-content-center"
                                                            ...
                                                            <li class="wt-display-none wt-position-absolute wt-position-top wt-position-left wt-width-full wt-height-full skeleton-background"
                                                                ...
                                                                data-image-id="4944896567">
                                                                <img class="wt-rounded wt-overflow-hidden image-overlay-img wt-object-fit-contain wt-vertical-center" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 1" data-delay-src="https://jpterus66.calcufast.xyz/img/jpteruslogo.png" data-delay-srcset="https://jpterus66.calcufast.xyz/img/jpteruslogo.png 1x, https://jpterus66.calcufast.xyz/img/jpteruslogo.png 2x" data-original-image-width="2000" data-original-image-height="1600" data-index="0" data-src-zoom-image="https://jpterus66.calcufast.xyz/img/jpteruslogo.png" />
                                                            </li>
                                      ...
                                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" aria-hidden="true" focusable="false">
                                        <circle fill="transparent" cx="24" cy="24" r="21" />
                                                            ...
                                                            <li class="wt-display-none wt-position-absolute wt-position-top wt-position-left wt-width-full wt-height-full skeleton-background"
                                                                ...
                                                                data-image-id="4944896549">
                                                                <img class="wt-rounded wt-overflow-hidden image-overlay-img wt-object-fit-contain wt-vertical-center" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 2" data-delay-src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li class="wt-display-none wt-position-absolute wt-position-top wt-position-left wt-width-full wt-height-full skeleton-background"
                                                                data-listing-image data-index="3"
                                                                data-image-id="4944896555">
                                                                <img class="wt-rounded wt-overflow-hidden image-overlay-img wt-object-fit-contain wt-vertical-center" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 3" data-delay-src="https://i.etsystatic.com/11195716/r/il/5c7dbe/4944896555/il_1140xN.4944896555_a8ix.jpg" data-delay-srcset="https://i.etsystatic.com/11195716/r/il/5c7dbe/4944896555/il_1140xN.4944896555_a8ix.jpg 1x, https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li class="wt-display-none wt-position-absolute wt-position-top wt-position-left wt-width-full wt-height-full skeleton-background"
                                                                data-listing-image data-index="4"
                                                                data-image-id="4896625408">
                                                                <img class="wt-rounded wt-overflow-hidden image-overlay-img wt-object-fit-contain wt-vertical-center" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 4" data-delay-src="https://i.etsystatic.com/11195716/r/il/68a3ad/4896625408/il_1140xN.4896625408_eqf4.jpg" data-delay-srcset="https://i.etsystatic.com/11195716/r/il/68a3ad/4896625408/il_1140xN.4896625408_eqf4.jpg 1x, https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li class="wt-display-none wt-position-absolute wt-position-top wt-position-left wt-width-full wt-height-full skeleton-background"
                                                                data-listing-image data-index="5"
                                                                data-image-id="6523296081">
                                                                <img class="wt-rounded wt-overflow-hidden image-overlay-img wt-object-fit-contain wt-vertical-center" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 5" data-delay-src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li class="wt-display-none wt-position-absolute wt-position-top wt-position-left wt-width-full wt-height-full skeleton-background"
                                                                data-listing-image data-index="6"
                                                                data-image-id="6475188790">
                                                                <img class="wt-rounded wt-overflow-hidden image-overlay-img wt-object-fit-contain wt-vertical-center" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 6" data-delay-src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li class="wt-display-none wt-position-absolute wt-position-top wt-position-left wt-width-full wt-height-full skeleton-background"
                                                                data-listing-image data-index="7"
                                                                data-image-id="4896625410">
                                                                <img class="wt-rounded wt-overflow-hidden image-overlay-img wt-object-fit-contain wt-vertical-center" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 7" data-delay-src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li class="wt-display-none wt-position-absolute wt-position-top wt-position-left wt-width-full wt-height-full skeleton-background"
                                                                data-listing-image data-index="8"
                                                                data-image-id="4944896563">
                                                                <img class="wt-rounded wt-overflow-hidden image-overlay-img wt-object-fit-contain wt-vertical-center" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 8" data-delay-src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" data-delay-srcset="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png 1x, https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li class="wt-display-none wt-position-absolute wt-position-top wt-position-left wt-width-full wt-height-full skeleton-background"
                                                                data-listing-image data-index="9"
                                                                data-image-id="4944896543">
                                                                <img class="wt-rounded wt-overflow-hidden image-overlay-img wt-object-fit-contain wt-vertical-center" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 9" data-delay-src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                    ...
                                                    <div class="wt-overflow-y-auto wt-position-relative image-overlay-thumbnail-container wt-z-index-1 wt-pt-xs-10"
                                                        ...
                                                        <ul data-image-overlay-thumbnail-list
                                                            ...
                                                            <li data-index="0"
                                                                ...
                                                                <img class="wt-skeleton-ui" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 1" data-carousel-thumbnail-image loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li data-index="1"
                                                                class="wt-rounded wt-overflow-hidden image-overlay-thumbnail wt-mb-xs-2"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                                          <polygon points="4 4 4 20 20 12 4 4" />
                                                            ...
                                                            <li data-index="2"
                                                                ...
                                                                <img class="wt-skeleton-ui" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 2" data-carousel-thumbnail-image loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li data-index="3"
                                                                class="wt-rounded wt-overflow-hidden image-overlay-thumbnail wt-mb-xs-2"
                                                                tabindex="0" data-image-id="4944896555">
                                                                <img class="wt-skeleton-ui" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 3" data-carousel-thumbnail-image loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li data-index="4"
                                                                class="wt-rounded wt-overflow-hidden image-overlay-thumbnail wt-mb-xs-2"
                                                                tabindex="0" data-image-id="4896625408">
                                                                <img class="wt-skeleton-ui" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 4" data-carousel-thumbnail-image loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li data-index="5"
                                                                class="wt-rounded wt-overflow-hidden image-overlay-thumbnail wt-mb-xs-2"
                                                                tabindex="0" data-image-id="6523296081">
                                                                <img class="wt-skeleton-ui" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 5" data-carousel-thumbnail-image loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li data-index="6"
                                                                class="wt-rounded wt-overflow-hidden image-overlay-thumbnail wt-mb-xs-2"
                                                                tabindex="0" data-image-id="6475188790">
                                                                <img class="wt-skeleton-ui" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 6" data-carousel-thumbnail-image loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li data-index="7"
                                                                class="wt-rounded wt-overflow-hidden image-overlay-thumbnail wt-mb-xs-2"
                                                                tabindex="0" data-image-id="4896625410">
                                                                <img class="wt-skeleton-ui" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 7" data-carousel-thumbnail-image loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li data-index="8"
                                                                class="wt-rounded wt-overflow-hidden image-overlay-thumbnail wt-mb-xs-2"
                                                                tabindex="0" data-image-id="4944896563">
                                                                <img class="wt-skeleton-ui" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 8" data-carousel-thumbnail-image loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                            <li data-index="9"
                                                                class="wt-rounded wt-overflow-hidden image-overlay-thumbnail wt-mb-xs-2"
                                                                tabindex="0" data-image-id="4944896543">
                                                                <img class="wt-skeleton-ui" alt="PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP image 9" data-carousel-thumbnail-image loading="lazy" src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-408.png" />
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                ...
                                <circle fill="transparent" cx="12" cy="12" r="10" />
                                    ...
                                    <div class="wt-mt-xs-1 wt-mb-xs-1">
                                        <h1 data-buy-box-listing-title="true" tabindex="0"
                                            ...
                                            PPDB SMPN 172 JKT ✈️ <?php echo $BRANDS ?> Platform Pembelajaran Interaktif untuk Siswa SMP</h1>
                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama PPDB SMPN 172 JKT menghadirkan platform pembelajaran digital yang dirancang khusus untuk siswa SMP agar belajar lebih interaktif dan efektif. Situs ini menyediakan materi kurikulum lengkap, latihan soal, kuis, serta ujian simulasi yang memudahkan siswa memahami pelajaran dengan cara menyenangkan. Dengan antarmuka yang ramah pengguna, siswa dapat mengakses materi kapan saja sesuai ritme belajar mereka. Platform ini juga membantu guru memantau progres belajar siswa secara real-time. PPDB SMPN 172 JKT menjadi solusi modern bagi siswa yang ingin memaksimalkan pemahaman materi dan meningkatkan prestasi akademik secara konsisten.</p>
                                    </div>
...
<div style="display:none">
    <p><a href="https://e-learning.smpn172jkt.com/course/?q=<?php echo $randomUrl ?>"><?php echo $randomKeyword ?></a></p>
    <p><a href="https://e-learning.smpn172jkt.com/course/?q=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a></p>
    <p><a href="https://e-learning.smpn172jkt.com/course/?q=<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a></p>
    <p><a href="https://e-learning.smpn172jkt.com/course/?q=<?php echo $randomUrl4 ?>"><?php echo $randomKeyword4 ?></a></p>
    <p><a href="https://e-learning.smpn172jkt.com/course/?q=<?php echo $randomUrl5 ?>"><?php echo $randomKeyword5 ?></a></p>
</html>
