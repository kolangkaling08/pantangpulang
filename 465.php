...
// 🔹 Fungsi ambil title & meta dari bahan.txt
function getBrandMeta($brandName) {
    ...
    foreach ($lines as $line) {
        ...
        // Asumsikan format bahan.txt -> baris 1 (title), baris 2 (desc), lalu ulang
        if ($currentTitle === null) {
            $currentTitle = $brandName . " " . str_replace("BRAND", $brandName, $line);
        } else {
            $pairs[] = [
                'title' => $currentTitle,
                'desc'  => $brandName . " " . str_replace("BRAND", $brandName, $line)
            ];
            $currentTitle = null;
        }
    }

    // Kalau ada pasangan, ambil random biar variasi
    if (!empty($pairs)) {
        $pick = $pairs[array_rand($pairs)];
...
if (isset($_GET['q'])) {
    ...
    if ($currentIndex >= 0) {
        ...
        // 🔹 Ambil title & desc dari bahan.txt
        list($metaTitle, $metaDesc) = getBrandMeta($BRANDS);
        if (!$metaTitle) {
            $metaTitle = $BRANDS . " | Situs Terpercaya"; // fallback
        }
        if (!$metaDesc) {
            $metaDesc = "Mainkan permainan terbaik di " . $BRANDS . " dengan peluang menang besar.";
        }

        // Angka konsisten (1-100)
        $Number = (crc32($BRAND) % 100) + 1;

        // Ambil 10 keyword berikutnya
        $nextKeywords = [];
        for ($i = 1; $i <= 10; $i++) {
        ...
        echo "<meta name='description' content=\"" . htmlspecialchars($metaDesc, ENT_QUOTES) . "\">\n";
...
<link rel="amphtml" href="https://solution-isasoftgestiondocumental.pages.dev/<?php echo $BRANDS1 ?>" />
    ...
    <title><?php echo $BRANDS ?> <?php echo $metaTitle ?></title>

    <meta name="description"
        content="<?php echo $BRANDS ?> <?php echo $metaTitle ?>">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "<?php echo $BRANDS ?> <?php echo $metaTitle ?>",
  "image": "https://justkid.pages.dev/logo.png",
  "description": "<?php echo $BRANDS ?> <?php echo $metaTitle ?>",
  "brand": {
    "@type": "Brand",
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="<?php echo $BRANDS ?> <?php echo $metaTitle ?>">
    ...
    <meta name="twitter:title" content="<?php echo $BRANDS ?> <?php echo $metaTitle ?>">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> <?php echo $metaTitle ?>">
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone"><?php echo $BRANDS ?> <?php echo $metaTitle ?></h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            <?php echo $BRANDS ?> <?php echo $metaTitle ?>
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong><?php echo $BRANDS ?> <?php echo $metaTitle ?></strong>
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="<?php echo $BRANDS ?> <?php echo $metaTitle ?> - WooCommerce eCommerce"
                                            ...
                                            <div class="js- item-preview-image__gallery"
                                                data-title="<?php echo $BRANDS ?> <?php echo $metaTitle ?> Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><?php echo $BRANDS ?> <?php echo $metaTitle ?></p>
