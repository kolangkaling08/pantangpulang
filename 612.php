...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://course-chaconvision.pages.dev/system/?q=<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title>Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan Chacon Vision menyediakan layanan optik, diagnosa mata, konsultasi oftalmologi, serta solusi visual modern dan personal.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional",
  "image": "https://jpterus66.calcufast.xyz/img/jpteruslogo.png",
  "description": "<?php echo $BRANDS ?> dan Chacon Vision menyediakan layanan optik, diagnosa mata, konsultasi oftalmologi, serta solusi visual modern dan personal.",
  "brand": {
    "@type": "Brand",
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?php echo $BRANDS ?>",
      "item": "https://www.chaconvision.com/course/<?php echo $BRANDS1 ?>"
    },
    {
      "@type": "ListItem",
      "position": 2,
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional">
    ...
    <meta name="twitter:title" content="Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan Chacon Vision menyediakan layanan optik, diagnosa mata, konsultasi oftalmologi, serta solusi visual modern dan personal.">
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone">Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong>Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional</strong>
...
<!-- Section 2 -->
                    ...
                    <div class="content-main" id="content" bis_skin_checked="1">
                        ...
                        <div class="grid-container" bis_skin_checked="1">
                            <script nonce="TFNQUvYHwdi8uHoMheRs/Q==">
                                //<![CDATA[
                                window.GtmMeasurements.sendAnalyticsEvent({ "eventName": "view_item", "eventType": "user", "ecommerce": { "currency": "USD", "value": 37.0, "items": [{ "affiliation": "themeforest", "item_id": 8988002, "item_name": Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional Hari Ini", "item_brand": "tokopress", "item_category": "wordpress", "item_category2": "ecommerce", "item_category3": "woocommerce", "price": 37.0, "quantity": 1, "item_add_on": "bundle_6month", "item_variant": "regular" }] } });
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/jpterus66/"><img
                                                    alt="Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional - WooCommerce eCommerce"
                                                    width="300" height="300"
                                                    srcset="https://jpterus66.calcufast.xyz/JPTERUS66/banner-90.png"
                                                    sizes="(min-width: 1024px) 590px, (min-width: 1px) 100vw, 600px"
                                                    src="https://jpterus66.calcufast.xyz/JPTERUS66/banner-90.png"></a>
                                            <div class="js- item-preview-image__gallery"
                                                data-title="Chacon Vision | <?php echo $BRANDS ?> Klinik Mata & Layanan Visual Profesional Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama Chacon Vision menyajikan layanan kesehatan mata lengkap mulai dari pemeriksaan visual, penyesuaian lensa, hingga konsultasi oftalmologi lanjutan. Klinik ini berfokus pada kenyamanan pasien dan teknologi canggih untuk diagnosa akurat. Dengan staf profesional dan peralatan optik modern, Chacon Vision membantu klien menjaga kesehatan penglihatan serta menemukan solusi terbaik sesuai kebutuhan visual mereka. Kolaborasi ini membawa visi bahwa penglihatan yang sehat adalah fondasi kualitas hidup sehari-hari.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://www.chaconvision.com/course/<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://www.chaconvision.com/course/<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
