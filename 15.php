...
if (isset($_GET['campus'])) {
    ...
    foreach ($lines as $index => $item) {
        ...
        if ($normalizedItem === $input) {
            $currentIndex = $index;
            $BRAND = $item; // Simpan nilai juansanojai dari file
            break;
        }
    }
...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="en-US" data-authenticated-account="" class="wf-adobegaramondpro-n4-inactive wf-orpheuspro-n5-inactive wf-adobegaramondpro-n7-inactive wf-orpheuspro-n4-inactive wf-orpheuspro-n7-inactive wf-orpheuspro-i4-inactive wf-adobegaramondpro-i4-inactive wf-adobegaramondpro-i7-inactive wf-inactive" style="--header-fixed-top-offset: 104.28125px;"><head>
    ...
    <base href="<?php echo $urlPath ?>">
        <title>juansanoja | <?php echo $BRANDS ?> Transformasi Emosional & Kesadaran Hidup</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="image/x-icon" href="https://athena88.pages.dev/icon.png" />
    <link rel="canonical" href="<?php echo $urlPath ?>" />
    <link rel="amphtml" href="https://juansanoja.pages.dev/amp/?campus=<?php echo $BRANDS1 ?>"/>
    <meta property="og:site_name" content="<?php echo $urlPath ?>" />
    <meta property="og:title" content="juansanoja | <?php echo $BRANDS ?> Transformasi Emosional & Kesadaran Hidup" />
    <meta property="og:url" content="<?php echo $urlPath ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="<?php echo $BRANDS ?> - juansanoja menyuguhkan coaching berbasis kecerdasan emosional untuk meningkatkan kesadaran, energi, dan kualitas hidup secara menyeluruh." />
    ...
    <meta itemprop="name" content="juansanoja | <?php echo $BRANDS ?> Transformasi Emosional & Kesadaran Hidup" />
    <meta itemprop="url" content="<?php echo $urlPath ?>" />
    <meta itemprop="description" content="<?php echo $BRANDS ?> - juansanoja menyuguhkan coaching berbasis kecerdasan emosional untuk meningkatkan kesadaran, energi, dan kualitas hidup secara menyeluruh." />
    ...
    <meta name="twitter:title" content="juansanoja | <?php echo $BRANDS ?> Transformasi Emosional & Kesadaran Hidup" />
    <meta name="twitter:image" content="https://athena88.pages.dev/3.jpg" />
    <meta name="twitter:url" content="<?php echo $urlPath ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="<?php echo $BRANDS ?> - juansanoja menyuguhkan coaching berbasis kecerdasan emosional untuk meningkatkan kesadaran, energi, dan kualitas hidup secara menyeluruh." />
    <meta name="description" content="<?php echo $BRANDS ?> - juansanoja menyuguhkan coaching berbasis kecerdasan emosional untuk meningkatkan kesadaran, energi, dan kualitas hidup secara menyeluruh." />
    ...
    <script
      type="application/ld+json">{"name":"juansanoja | <?php echo $BRANDS ?> Transformasi Emosional & Kesadaran Hidup \u2014 <?php echo $urlPath ?>","image":"https://athena88.pages.dev/3.jpg","description":"<?php echo $BRANDS ?> - juansanoja menyuguhkan coaching berbasis kecerdasan emosional untuk meningkatkan kesadaran, energi, dan kualitas hidup secara menyeluruh.","brand":"<?php echo $urlPath ?>","offers":{"price":888.00,"priceCurrency":"IDR","url":"<?php echo $urlPath ?>","availability":"InStock","sku":"SQ1936194","@context":"http://schema.org","@type":"Offer"},"@context":"http://schema.org","@type":"Product"}</script>
    <link rel="stylesheet" type="text/css"
  ...
  " data-animation-role="header-element">
      ...
      '>
              <div class="content">
                ...
                <div class="n-columns-2">
                  <a href="https://juansanoja.pages.dev/" rel="nofollow noreferrer" class="login">LOGIN</a>
                  <a href="https://juansanoja.pages.dev/" rel="nofollow noreferrer" class="register">DAFTAR</a>
                  </div>
                  ...
                  <article
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link">juansanoja | <?php echo $BRANDS ?> Transformasi Emosional & Kesadaran Hidup</a>
                      </div>
    ...
    " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                          juansanoja | <?php echo $BRANDS ?> Transformasi Emosional & Kesadaran Hidup</h1><div data-controller="ProductItemVariants,ProductCartButton" class="ProductItem-details-checkout" data-controllers-bound="ProductItemVariants,ProductCartButton">
  ...
  <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a>, juansanoja adalah platform pengembangan diri yang menghadirkan blog inspiratif, komunitas privat, sessi coaching personal, dan bootcamp transformatif. Dikenal sebagai "Entender La Vida", Juan Sanoja memadukan pendekatan nasional dan spiritual dalam membimbing individu untuk mengubah rasa sakit menjadi pelajaran berharga. Dengan materi seputar produktivitas, motivasi, dan keseimbangan emosional, serta testimoni pengguna yang menyentuh seperti perubahan perspektif hidup dan pengelolaan emosi secara penuh juanSanoja membentuk ruang komunitas yang mendukung evolusi diri dengan hangat, praktis, dan bermakna.</p>
