...
<head>
    ...
    <title><?php echo $BRANDS ?> | 1Pix Media Agensi Kreatif & Pengembangan Digital</title>
    <link rel="amphtml" href="https://about-1pixmedia.pages.dev/?q=<?php echo $BRANDS1 ?>" />
    <meta name="description" content="1Pix Media menghadirkan layanan kreatif digital, desain, branding, serta pengembangan web inovatif untuk mendukung bisnis tampil lebih profesional dan menarik." itemprop="description" />
    <meta name="originalTitle" content="<?php echo $BRANDS ?> | 1Pix Media Agensi Kreatif & Pengembangan Digital" />
    <meta charset="utf-8"> 
    <meta property="og:type" content="article" />
    <meta property="og:site_name" content="<?php echo $BRANDS ?>" />
    <meta property="og:title" content="<?php echo $BRANDS ?> | 1Pix Media Agensi Kreatif & Pengembangan Digital" />
    <meta property="og:image" content="https://justkid.pages.dev/20.png" />
    <meta property="og:description" content="1Pix Media menghadirkan layanan kreatif digital, desain, branding, serta pengembangan web inovatif untuk mendukung bisnis tampil lebih profesional dan menarik." />
    ...
    <meta content="1Pix Media menghadirkan layanan kreatif digital, desain, branding, serta pengembangan web inovatif untuk mendukung bisnis tampil lebih profesional dan menarik." itemprop="headline" />
    <meta name="keywords" content="yusuf dikec,olimpiade paris,olimpiade paris 2024" itemprop="keywords" />
    <meta name="thumbnailUrl" content="https://justkid.pages.dev/20.png" itemprop="thumbnailUrl" />
    ...
    <meta name="twitter:description" content="1Pix Media menghadirkan layanan kreatif digital, desain, branding, serta pengembangan web inovatif untuk mendukung bisnis tampil lebih profesional dan menarik." />
    <meta name="twitter:image" content="https://justkid.pages.dev/20.png" />
    ...
    <meta name="dtk:thumbnailUrl" content="https://justkid.pages.dev/20.png" itemprop="thumbnailUrl" />
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "headline": "<?php echo $BRANDS ?> | 1Pix Media Agensi Kreatif & Pengembangan Digital",
    ...
    <script type="application/ld+json">
        {
            ...
            "description": "1Pix Media menghadirkan layanan kreatif digital, desain, branding, serta pengembangan web inovatif untuk mendukung bisnis tampil lebih profesional dan menarik."
        }
        </script>
            <script type="application/ld+json">
{
    ...
    <div class="container">
        ...
        <article class="detail">
            ...
            <div class="detail__header">
                ...
                <h1 class="detail__title"><?php echo $BRANDS ?> | 1Pix Media Agensi Kreatif & Pengembangan Digital</h1>
            ...
            <div class="content">
                ...
                <div class="detail__media">
                    <figure dtr-evt="cover image" dtr-sec="" dtr-act="cover image" onclick="_pt(this)"
                        ...
                        <img src="https://justkid.pages.dev/20.png" alt="Yusuf Dikec"
                ...
                <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama 1Pix Media memperkenalkan agensi kreatif yang berfokus pada desain, branding, dan pengembangan digital. Dengan visi menghadirkan solusi multimedia yang inovatif, 1Pix Media membantu bisnis membangun identitas visual yang kuat dan relevan dengan target audiens. Layanan yang ditawarkan mencakup desain grafis, produksi konten visual, hingga pembuatan situs web yang responsif dan modern. Meskipun saat ini situs resmi mereka masih dalam tahap pengembangan, nama dan arah branding menunjukkan fokus utama pada kualitas visual serta kreativitas digital. Bagi perusahaan yang ingin meningkatkan daya tarik merek serta memperkuat kehadiran online, 1Pix Media bisa menjadi mitra strategis untuk pertumbuhan jangka panjang.</p>
                        ...
                        <tr>
                            <td>
                                <div class="lihatjg"><strong>Baca juga: </strong><a data-label="List Berita"
                                        ...
                                        <?php echo $BRANDS ?> | 1Pix Media Agensi Kreatif & Pengembangan Digital</a></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="sticky-share">
            <div class="detail__share sticky-share__wrap">
                <a dtr-evt="floating komentar" dtr-sec="tombol komentar" dtr-act="tombol komentar" onclick="_pt(this)"
                    ...
                    data-title="<?php echo $BRANDS ?> | 1Pix Media Agensi Kreatif & Pengembangan Digital"
                    data-image="https://res.cloudinary.com/dlnvwjm0j/image/upload/v1722855586/cocain_eogid1.jpg"
                    data-desc="1Pix Media menghadirkan layanan kreatif digital, desain, branding, serta pengembangan web inovatif untuk mendukung bisnis tampil lebih profesional dan menarik."
                ...
                getScript("https://awscdn.detik.net.id/libs/comment/v2/js/zoid.min.js?2024080215", function () {
                    getScript("https://awscdn.detik.net.id/libs/comment/v2/js/bridge.js?2024080215", function () {
                        ...
                        CommentComponent({
                            ...
                            kanal: 398,
                            date: "02-08-2024",
                            title: "<?php echo $BRANDS ?> | 1Pix Media Agensi Kreatif & Pengembangan Digital",
                            clientId: 98,
                            prefix: "dtk",
                            prokontra: 0,
                            pembukaDiskusi: "",
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="1"
                                ...
                                href="https://1pixmedia.net/about/?q=<?php echo $randomUrl ?>" class="media__link"><?php echo $randomKeyword ?></a>
                        </h3>
                    </div>
                </div>
            </article>
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="2"
                                ...
                                href="https://1pixmedia.net/about/?q=<?php echo $randomUrl2 ?>" class="media__link"><?php echo $randomKeyword2 ?></a>
                        </h3>
                    </div>
                </div>
            </article>
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="3"
                                dtr-id="7469546"
                                dtr-ttl="<?php echo $randomKeyword3 ?>" href="https://1pixmedia.net/about/?q=<?php echo $randomUrl3 ?>"
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="4"
                                dtr-id="7470202"
                                dtr-ttl="<?php echo $randomKeyword4 ?>" href="https://1pixmedia.net/about/?q=<?php echo $randomUrl4 ?>"
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="5"
                                ...
                                href="https://1pixmedia.net/about/?q=<?php echo $randomUrl5 ?>" class="media__link"><?php echo $randomKeyword5 ?></a>
                        </h3>
                    </div>
                </div>
            </article>
                    ...
                    <div class="media__text">
                        <h3 class="media__title">
                            <a dtr-evt="berita terkait" dtr-sec="" dtr-act="artikel" onclick="_pt(this)" dtr-idx="6"
                                ...
                                href="https://1pixmedia.net/about/?q=<?php echo $randomUrl6 ?>" class="media__link"><?php echo $randomKeyword6 ?></a>
                        </h3>
                    </div>
                </div>
            </article>
