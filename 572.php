...
//]]></script>
    ...
    <link rel="amphtml" href="https://course-solidaridadsouthamerica.pages.dev/system/?q=<?php echo $BRANDS1 ?>"/>
                                                    ...
                                                    <div bis_skin_checked="1">
                                                        ...
                                                        <p>
                                                            <strong>Keyword Terkait :</strong>
                                                                <ul>
                                                            <li><strong><a href="https://course-cursoseew/?q=<?php echo $randomUrl ?>"><?php echo $randomKeyword ?></a></strong></li> 
                                                            <li><strong><a href="https://course-cursoseew/?q=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a></strong></li> 
                                                            <li><strong><a href="https://course-cursoseew/?q=<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a></strong></li> 
                                                            <li><strong><a href="https://course-cursoseew/?q=<?php echo $randomUrl4 ?>"><?php echo $randomKeyword4 ?></a></strong></li> 
                                                            <li><strong><a href="https://course-cursoseew/?q=<?php echo $randomUrl5 ?>"><?php echo $randomKeyword5 ?></a></strong></li>  
                                                               </ul>
                                                        </p>
