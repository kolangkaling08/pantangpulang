...
function getBrandMeta($brandName) {
    ...
    foreach ($lines as $line) {
        ...
        // Format: baris 1 = Title, baris 2 = Desc
        if ($currentTitle === null) {
            // replace placeholder dengan nama brand
            $line = str_replace(["BRAND", "<?php echo \$BRANDS ?>"], $brandName, $line);
            $currentTitle = $brandName . " " . $line;
        } else {
            $line = str_replace(["BRAND", "<?php echo \$BRANDS ?>"], $brandName, $line);
            $pairs[] = [
                'title' => $currentTitle,
