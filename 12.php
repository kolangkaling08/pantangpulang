...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="en-US" data-authenticated-account="" class="wf-adobegaramondpro-n4-inactive wf-orpheuspro-n5-inactive wf-adobegaramondpro-n7-inactive wf-orpheuspro-n4-inactive wf-orpheuspro-n7-inactive wf-orpheuspro-i4-inactive wf-adobegaramondpro-i4-inactive wf-adobegaramondpro-i7-inactive wf-inactive" style="--header-fixed-top-offset: 104.28125px;"><head>
    ...
    <base href="<?php echo $urlPath ?>">
        <title>sasmiperu | <?php echo $BRANDS ?> Catering & Solusi Integral</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="image/x-icon" href="https://athena88.pages.dev/icon.png" />
    <link rel="canonical" href="<?php echo $urlPath ?>" />
    <link rel="amphtml" href="https://sasmiperu.pages.dev/?campus=<?php echo $BRANDS1 ?>"/>
    ...
    <meta property="og:description" content="<?php echo $BRANDS ?> - sasmiperu menghadirkan layanan catering, restauración, hotelería y más, especialmente diseñadas para sectores industriales y mineros." />
    ...
    <meta itemprop="name" content="sasmiperu | <?php echo $BRANDS ?> Catering & Solusi Integral" />
    <meta itemprop="url" content="<?php echo $urlPath ?>" />
    <meta itemprop="description" content="<?php echo $BRANDS ?> - sasmiperu menghadirkan layanan catering, restauración, hotelería y más, especialmente diseñadas para sectores industriales y mineros." />
    ...
    <meta name="twitter:title" content="sasmiperu | <?php echo $BRANDS ?> Catering & Solusi Integral" />
    <meta name="twitter:image" content="https://athena88.pages.dev/1.jpg" />
    <meta name="twitter:url" content="<?php echo $urlPath ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="<?php echo $BRANDS ?> - sasmiperu menghadirkan layanan catering, restauración, hotelería y más, especialmente diseñadas para sectores industriales y mineros." />
    <meta name="description" content="<?php echo $BRANDS ?> - sasmiperu menghadirkan layanan catering, restauración, hotelería y más, especialmente diseñadas para sectores industriales y mineros." />
    ...
    <script
      type="application/ld+json">{"name":"sasmiperu | <?php echo $BRANDS ?> Catering & Solusi Integral \u2014 <?php echo $urlPath ?>","image":"https://athena88.pages.dev/1.jpg","description":"<?php echo $BRANDS ?> - sasmiperu menghadirkan layanan catering, restauración, hotelería y más, especialmente diseñadas para sectores industriales y mineros.","brand":"<?php echo $urlPath ?>","offers":{"price":888.00,"priceCurrency":"IDR","url":"<?php echo $urlPath ?>","availability":"InStock","sku":"SQ1936194","@context":"http://schema.org","@type":"Offer"},"@context":"http://schema.org","@type":"Product"}</script>
    <link rel="stylesheet" type="text/css"
  ...
  " data-animation-role="header-element">
                  ...
                  <article
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link">sasmiperu | <?php echo $BRANDS ?> Catering & Solusi Integral</a>
                      </div>
    ...
    " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                          sasmiperu | <?php echo $BRANDS ?> Catering & Solusi Integral</h1><div data-controller="ProductItemVariants,ProductCartButton" class="ProductItem-details-checkout" data-controllers-bound="ProductItemVariants,ProductCartButton">
  ...
  <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> - sasmiperu es una empresa peruana especializada en servicios integrales de alimentación colectiva, catering, hostelería, lavandería, limpieza y mantenimiento, enfocada en industrias eminas. Con experiencia regional y presencia en Lima y Arequipa, ofrecen soluciones personalizadas que combinan ingredientes naturales, gastronomía variada, chefs creativos y gestión completa de instalaciones. Apuntan a simplificar operaciones internas de sus clientes, permitiéndoles enfocarse en sus principales actividades mientras disfrutan de calidad, cumplimiento y bienestar para su equipo.</p> 
                          </div>
