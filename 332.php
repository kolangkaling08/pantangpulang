...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://program-puppykingdomsg.pages.dev/?q=<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title>SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan SIGESITTB menyajikan sistem online diagnosa TB dan resistensi obat, memudahkan pasien & tenaga medis mengakses hasil laboratorium.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya",
  "image": "https://athena88.pages.dev/logo-1.png",
  "description": "<?php echo $BRANDS ?> dan SIGESITTB menyajikan sistem online diagnosa TB dan resistensi obat, memudahkan pasien & tenaga medis mengakses hasil laboratorium.",
  "brand": {
    "@type": "Brand",
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya">
    ...
    <meta name="twitter:title" content="SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan SIGESITTB menyajikan sistem online diagnosa TB dan resistensi obat, memudahkan pasien & tenaga medis mengakses hasil laboratorium.">
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone">SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong>SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya</strong>
...
<!-- Section 2 -->
                    ...
                    <div class="content-main" id="content" bis_skin_checked="1">
                        ...
                        <div class="grid-container" bis_skin_checked="1">
                            <script nonce="TFNQUvYHwdi8uHoMheRs/Q==">
                                //<![CDATA[
                                window.GtmMeasurements.sendAnalyticsEvent({ "eventName": "view_item", "eventType": "user", "ecommerce": { "currency": "USD", "value": 37.0, "items": [{ "affiliation": "themeforest", "item_id": 8988002, "item_name": SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya Hari Ini", "item_brand": "tokopress", "item_category": "wordpress", "item_category2": "ecommerce", "item_category3": "woocommerce", "price": 37.0, "quantity": 1, "item_add_on": "bundle_6month", "item_variant": "regular" }] } });
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya - WooCommerce eCommerce"
                                            ...
                                            <div class="js- item-preview-image__gallery"
                                                data-title="SIGESITTB Puskesmas Sidomulyo | <?php echo $BRANDS ?> Sistem Diagnosa TB Responsif Terpercaya Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> bersama SIGESITTB Puskesmas Sidomulyo menghadirkan inovasi layanan kesehatan berbasis digital untuk penyakit Tuberkulosis. Melalui platform Check Lab Result dan Form TB05 Rujukan Spesimen TB, pasien dapat melihat hasil lab secara daring, mengisi rujukan spesimen, dan tenaga medis dapat menindaklanjuti dengan lebih cepat. Sistem ini mempercepat alur diagnosis TB Sensitif dan Resisten Obat, mendukung pelaporan yang akurat, serta memperkuat penanganan sejak dini. Dengan layanan real-time dan user friendly, SIGESITTB memastikan bahwa masyarakat mendapatkan pelayanan yang transparan, efisien, dan berkualitas dalam upaya pencegahan dan pengobatan TB.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://puppykingdomsg.com/program/?q=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://puppykingdomsg.com/program/?q=<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
