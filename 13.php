...
if (isset($_GET['campus'])) {
    ...
    foreach ($lines as $index => $item) {
        ...
        if ($normalizedItem === $input) {
            $currentIndex = $index;
            $BRAND = $item; // Simpan nilai emeritei dari file
            break;
        }
    }
...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="en-US" data-authenticated-account="" class="wf-adobegaramondpro-n4-inactive wf-orpheuspro-n5-inactive wf-adobegaramondpro-n7-inactive wf-orpheuspro-n4-inactive wf-orpheuspro-n7-inactive wf-orpheuspro-i4-inactive wf-adobegaramondpro-i4-inactive wf-adobegaramondpro-i7-inactive wf-inactive" style="--header-fixed-top-offset: 104.28125px;"><head>
    ...
    <base href="<?php echo $urlPath ?>">
        <title>emerite | <?php echo $BRANDS ?> Pelatihan Profesional Pariwisata</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="image/x-icon" href="https://athena88.pages.dev/icon.png" />
    <link rel="canonical" href="<?php echo $urlPath ?>" />
    <link rel="amphtml" href="https://emerite.pages.dev/amp/?campus=<?php echo $BRANDS1 ?>"/>
    <meta property="og:site_name" content="<?php echo $urlPath ?>" />
    <meta property="og:title" content="emerite | <?php echo $BRANDS ?> Pelatihan Profesional Pariwisata" />
    <meta property="og:url" content="<?php echo $urlPath ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="<?php echo $BRANDS ?> - emerite menawarkan pelatihan dan sertifikasi berbasis standar nasional untuk tenaga kerja pariwisata di Kanada." />
    ...
    <meta itemprop="name" content="emerite | <?php echo $BRANDS ?> Pelatihan Profesional Pariwisata" />
    <meta itemprop="url" content="<?php echo $urlPath ?>" />
    <meta itemprop="description" content="<?php echo $BRANDS ?> - emerite menawarkan pelatihan dan sertifikasi berbasis standar nasional untuk tenaga kerja pariwisata di Kanada." />
    ...
    <meta name="twitter:title" content="emerite | <?php echo $BRANDS ?> Pelatihan Profesional Pariwisata" />
    <meta name="twitter:image" content="https://athena88.pages.dev/2.jpg" />
    <meta name="twitter:url" content="<?php echo $urlPath ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="<?php echo $BRANDS ?> - emerite menawarkan pelatihan dan sertifikasi berbasis standar nasional untuk tenaga kerja pariwisata di Kanada." />
    <meta name="description" content="<?php echo $BRANDS ?> - emerite menawarkan pelatihan dan sertifikasi berbasis standar nasional untuk tenaga kerja pariwisata di Kanada." />
    ...
    <script
      type="application/ld+json">{"name":"emerite | <?php echo $BRANDS ?> Pelatihan Profesional Pariwisata \u2014 <?php echo $urlPath ?>","image":"https://athena88.pages.dev/2.jpg","description":"<?php echo $BRANDS ?> - emerite menawarkan pelatihan dan sertifikasi berbasis standar nasional untuk tenaga kerja pariwisata di Kanada.","brand":"<?php echo $urlPath ?>","offers":{"price":888.00,"priceCurrency":"IDR","url":"<?php echo $urlPath ?>","availability":"InStock","sku":"SQ1936194","@context":"http://schema.org","@type":"Offer"},"@context":"http://schema.org","@type":"Product"}</script>
    <link rel="stylesheet" type="text/css"
  ...
  " data-animation-role="header-element">
      ...
      '>
              <div class="content">
                ...
                <div class="n-columns-2">
                  <a href="https://emerite.pages.dev/" rel="nofollow noreferrer" class="login">LOGIN</a>
                  <a href="https://emerite.pages.dev/" rel="nofollow noreferrer" class="register">DAFTAR</a>
                  </div>
                  ...
                  <article
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link">emerite | <?php echo $BRANDS ?> Pelatihan Profesional Pariwisata</a>
                      </div>
    ...
    " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                          emerite | <?php echo $BRANDS ?> Pelatihan Profesional Pariwisata</h1><div data-controller="ProductItemVariants,ProductCartButton" class="ProductItem-details-checkout" data-controllers-bound="ProductItemVariants,ProductCartButton">
  ...
  <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a>, emerite menghadirkan program pelatihan dan sertifikasi yang dirancang oleh industri untuk industri pariwisata di Kanada. Selama hampir 30 tahun, mereka menyediakan materi berbasis National Occupational Standards (NOS) untuk berbagai profesi seperti front desk agent, housekeeping, line cook melalui modul e-learning fleksibel dan sertifikasi profesional yang diakui nasional. Dikenal karena pendekatan yang fokus pada keterampilan praktis, emerite memungkinkan pekerja pariwisata mengasah kemampuan mereka secara real-time dan mengembangkan karier dengan lebih percaya diri. Kini dengan platform pembelajaran baru yang diluncurkan sejak Juni 2025, emerite makin memperkuat perannya sebagai sumber pembelajaran mutakhir dan profesional di sektor pariwisata Kanada.</p> 
                          </div>
