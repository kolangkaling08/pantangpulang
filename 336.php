...
<script type="text/javascript" async=""
    ...
    nonce="TFNQUvYHwdi8uHoMheRs/Q=="></script>
<link rel="amphtml" href="https://sosial-vvipmedia.pages.dev/?q=<?php echo $BRANDS1 ?>" />
    <meta charset="utf-8">
    ...
    <title>VVIP Media | <?php echo $BRANDS ?> Media Kreatif Layanan Publikasi & Produksi Berkualitas</title>

    <meta name="description"
        content="<?php echo $BRANDS ?> dan VVIP Media menyediakan jasa media kreatif, produksi konten, dan publikasi digital untuk brand dan individu dengan standarisasi profesional.">
   ...
   <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "VVIP Media | <?php echo $BRANDS ?> Media Kreatif Layanan Publikasi & Produksi Berkualitas",
  "image": "https://athena88.pages.dev/logo-1.png",
  "description": "<?php echo $BRANDS ?> dan VVIP Media menyediakan jasa media kreatif, produksi konten, dan publikasi digital untuk brand dan individu dengan standarisasi profesional.",
  "brand": {
    "@type": "Brand",
...
<script type="application/ld+json">
{
  ...
  "contactPoint": {
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="VVIP Media | <?php echo $BRANDS ?> Media Kreatif Layanan Publikasi & Produksi Berkualitas">
    ...
    <meta name="twitter:title" content="VVIP Media | <?php echo $BRANDS ?> Media Kreatif Layanan Publikasi & Produksi Berkualitas">
    <meta name="twitter:description" content="<?php echo $BRANDS ?> dan VVIP Media menyediakan jasa media kreatif, produksi konten, dan publikasi digital untuk brand dan individu dengan standarisasi profesional.">
                            ...
                            <div class="item-header" data-view="itemHeader" bis_skin_checked="1">
                                <div class="item-header__top" bis_skin_checked="1">
                                    <div class="item-header__title" bis_skin_checked="1">
                                        <h1 class="t-heading -color-inherit -size-l h-m0 is-hidden-phone">VVIP Media | <?php echo $BRANDS ?> Media Kreatif Layanan Publikasi & Produksi Berkualitas</h1>

                                        <h1 class="t-heading -color-inherit -size-xs h-m0 is-hidden-tablet-and-above">
                                            VVIP Media | <?php echo $BRANDS ?> Media Kreatif Layanan Publikasi & Produksi Berkualitas
                                        </h1>
                                    </div>
                                ...
                                <div class="item-header__details-section" bis_skin_checked="1">
                                    ...
                                    <div class="item-header__envato-highlighted" bis_skin_checked="1">
                                        <strong>VVIP Media | <?php echo $BRANDS ?> Media Kreatif Layanan Publikasi & Produksi Berkualitas</strong>
                                        ...
                                        <div class="item-preview live-preview-btn--blue -preview-live"
                                            ...
                                            <a target="_blank"
                                                href="https://heylink.me/PASTIWIN805/"><img
                                                    alt="VVIP Media | <?php echo $BRANDS ?> Media Kreatif Layanan Publikasi & Produksi Berkualitas - WooCommerce eCommerce"
                                            ...
                                            <div class="js- item-preview-image__gallery"
                                                data-title="VVIP Media | <?php echo $BRANDS ?> Media Kreatif Layanan Publikasi & Produksi Berkualitas Hari Ini - WooCommerce eCommerce Screenshots Gallery"
                                                ...
                                                <form data-view="purchaseForm" data-analytics-has-custom-click="true"
                                                    ...
                                                    <div bis_skin_checked="1">
                                                       ...
                                                       <div class="purchase-form__cta-buttons" bis_skin_checked="1">
                                                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> dan VVIP Media menghadirkan layanan media penuh mulai dari produksi video, fotografi, hingga kampanye digital. Brand dan individu yang ingin meningkatkan citra dapat mempercayakan pembuatan konten kreatif berkualitas tinggi kepada VVIP Media. Dengan tim profesional, proses editing, konsep visual, dan distribusi publikasi ke platform digital dijalankan secara matang. VVIP Media juga bantu strategi konten agar sesuai target audience dan tren marketing. Hasil akhir bukan sekadar konten, tapi karya media yang punya dampak visual dan komunikasi yang kuat.</p>
                                    ...
                                    <nav class="global-footer-info-links">
                                        ...
                                        <ul class="global-footer-info-links__list">
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://vvipmedia.com/sosial/?q=<?php echo $randomUrl2 ?>"><?php echo $randomKeyword2 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
                                            ...
                                            <li class="global-footer-info-links__list-item">
                                                <ul class="global-footer-sublist">
                                                    <li class="global-footer-sublist__item-title">
                                                        <a href="https://vvipmedia.com/sosial/?q=<?php echo $randomUrl3 ?>"><?php echo $randomKeyword3 ?></a>
                                                    </li>
                                                    <li class="global-footer-sublist__item h-p0">
                                                        <a class="global-footer__text-link"
